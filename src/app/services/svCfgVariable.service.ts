...
@Injectable()
export class SvCfgVariableService {
	private url = environment.apiUrl + 'msvvariable';
	public identity;
	public token;
	...
	getVariableByParametroId(token,idParametro) {
		let json = JSON.stringify(idParametro);
