...
@Injectable()
export class CfgOrganismoTransitoService {
	private url = environment.apiUrl + 'configuracion/cfgorganismotransito';
	public identity;
	public token;
	...
	selectSedes() {
		return this._http.get(this.url + "/select/sedes").map(res => res.json());
	}
}