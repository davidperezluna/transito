...
export class SvCfgEstadoIluminacionComponent implements OnInit {
    public errorMessage;
    public table: any;
    public estadosIluminacion;
    public respuesta;
    ...
    ngOnInit() {
        ...
        this._EstadoIluminacionService.index().subscribe(
            response => {
                this.estadosIluminacion = response.data;
    ...
    onDelete(id: any) {
        swal({
            ...
            if (result.value) {
                ...
                this._EstadoIluminacionService.delete({ 'id': id }, token).subscribe(
                    response => {
                        swal({
                            title: 'Eliminado!',
