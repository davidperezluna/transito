...
export class SvCfgTipoViaComponent implements OnInit {
    public errorMessage;
    public table: any;
    public tiposVia;
    public respuesta;
    ...
    ngOnInit() {
        ...
        this._TipoViaService.index().subscribe(
            response => {
                this.tiposVia = response.data;
    ...
    onDelete(id: any) {
        swal({
            ...
            if (result.value) {
                ...
                this._TipoViaService.delete({ 'id': id }, token).subscribe(
                    response => {
                        swal({
                            title: 'Eliminado!',
