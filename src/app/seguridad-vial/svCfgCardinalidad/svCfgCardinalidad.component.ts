...
export class SvCfgCardinalidadComponent implements OnInit {
    public errorMessage;
    public table: any;
    public cardinalidades;
    public respuesta;
    ...
    ngOnInit() {
        ...
        this._CardinalidadService.index().subscribe(
            response => {
                this.cardinalidades = response.data;
    ...
    onDelete(id: any) {
        swal({
            ...
            if (result.value) {
                ...
                this._CardinalidadService.delete({ 'id': id }, token).subscribe(
                    response => {
                        swal({
                            title: 'Eliminado!',
    ...
    editCardinalidad(cardinalidad: any) {
