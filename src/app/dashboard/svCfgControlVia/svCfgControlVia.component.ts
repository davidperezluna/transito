...
@Component({
    selector: 'app-index',
    templateUrl: './svCfgControlVia.component.html'
})
export class SvCfgControlViaComponent implements OnInit {
    public errorMessage;
    public table: any;
    public controlesVia;
    public respuesta;
    ...
    onDelete(id: any) {
        swal({
            ...
            if (result.value) {
                ...
                this._ControlViaService.delete({ 'id': id }, token).subscribe(
                    response => {
                        swal({
                            title: 'Eliminado!',
