...
constructor(
  private _tramiteSolicitudRncService: TramiteSolicitudService,
  ...
  onEnviar(){
    let token = this._loginService.getToken();
		this._tramiteSolicitudRncService.editTramiteSolicitud(this.tramiteSolicitud,token).subscribe(
			response => {
