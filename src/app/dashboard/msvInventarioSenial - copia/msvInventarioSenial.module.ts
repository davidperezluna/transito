...
@NgModule({
    ...
    providers: [MsvSenialInventarioService, CfgTipoDestinoService, CfgBodegaService, MunicipioService, CfgTipoSenialService, CfgTipoColorService, CfgTipoEstadoService, CfgInventarioService]
})
