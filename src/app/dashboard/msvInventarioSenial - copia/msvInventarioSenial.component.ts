...
export class MsvInventarioSenialComponent implements OnInit {
    ...
    constructor(
        ...
        //////////////////////////////////
    ) { this.senialSelected = ""; this.build = {};
    ...
    ngOnInit() {
        ...
        this._MsvInventarioSenialService.index().subscribe(
                response => {
                if (response) {
    ...
    searchBySenial(typeSen) {
        ...
        let token = this._loginService.getToken();
        this._MsvInventarioSenialService.searchByTipoSenialInBodega(this.datInv, token).subscribe(
                response => {
    ...
    onSend() {
        ...
        if(valid != ""){
            ...
            this._MsvInventarioSenialService.registerSenialBodega(this.file, this.msvInventarioSenial, token).subscribe(
                    response => {
