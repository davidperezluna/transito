...
@Component({
  selector: 'app-index',
  templateUrl: './svIpatImpresoBodega.component.html'
})

export class SvIpatImpresoBodegaComponent implements OnInit {
  public errorMessage;
	public bodegas;
  ...
  constructor(
    private _BodegaService: SvIpatImpresoBodegaService,
