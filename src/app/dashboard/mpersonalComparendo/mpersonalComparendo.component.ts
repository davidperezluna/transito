...
export class MpersonalComparendoComponent implements OnInit {
  public errorMessage;
	public id;
	public respuesta;
	public talonarios;
  ...
  public table:any; 
  public talonario: MpersonalComparendo;

  constructor(
    private _PersonalComparendoService: MpersonalComparendoService,
