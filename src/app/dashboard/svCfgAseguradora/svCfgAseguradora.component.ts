...
export class SvCfgAseguradoraComponent implements OnInit {
    public errorMessage;
    public table: any;
    public aseguradoras;
    public respuesta;
    ...
    ngOnInit() {
        ...
        this._AseguradoraService.index().subscribe(
            response => {
    ...
    onDelete(id: any) {
        swal({
            ...
            if (result.value) {
                ...
                this._AseguradoraService.delete({ 'id': id }, token).subscribe(
                    response => {
                        swal({
                            title: 'Eliminado!',
