...
export class SvCfgNacionalidadComponent implements OnInit {
    public errorMessage;
    public table: any;
    ...
    ngOnInit() {
        ...
        this._NacionalidadService.index().subscribe(
            response => {
    ...
    onDelete(id: any) {
        swal({
            ...
            if (result.value) {
                ...
                this._NacionalidadService.delete({ 'id': id }, token).subscribe(
                    response => {
                        swal({
                            title: 'Eliminado!',
