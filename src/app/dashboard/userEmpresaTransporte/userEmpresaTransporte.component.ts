...
export class UserEmpresaTransporteComponent implements OnInit {
    ...
    public empresaTransporte: UserEmpresaTransporte;
    ...
    ngOnInit() {
        ...
        this._UserEmpresaTransporteService.index().subscribe(
            response => {
                this.empresasTransporte = response.data;
