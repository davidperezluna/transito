...
@Component({
    selector: 'appRna-registroEntregaProducto',
    templateUrl: './newRna.registroEntregaProducto.html',
})
export class NewRnaRegistroEntregaProductoComponent implements OnInit {
