...
export class EditComponent {
  ...
  ngOnInit() {
    this._LineaService.select().subscribe(
      response => {
        ...
        setTimeout(() => {
            this.lineaSelected = [this.curso.linea.id]; 
        });
      }, 
      error => { 
    ...
    this._MarcaService.select().subscribe(
      response => {
        ...
        setTimeout(() => {
            this.marcaSelected = [this.curso.linea.marca.id];
        })
      }, 
      error => { 
        this.errorMessage = <any>error;
    ...
    this._ClaseService.select().subscribe(
      response => {
        ...
        setTimeout(() => {
          this.claseSelected = [this.curso.clase.id];
        });
      },
      error => {
        this.errorMessage = <any>error;
  ...
  onEnviar() {
    ...
    this.curso.claseId = this.claseSelected;
    this.curso.lineaId = this.lineaSelected;

    this._VhloValorService.edit(this.curso, token).subscribe(
      response => {
