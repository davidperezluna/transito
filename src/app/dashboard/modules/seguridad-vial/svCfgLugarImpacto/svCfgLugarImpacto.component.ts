...
@Component({
    selector: 'app-index',
    templateUrl: './svCfgLugarImpacto.component.html'
})
export class SvCfgLugarImpactoComponent implements OnInit {
    public errorMessage;
    public table: any;
    public lugaresImpacto;
    public respuesta;
    ...
    onDelete(id: any) {
        swal({
            ...
            if (result.value) {
                ...
                this._LugarImpactoService.delete({ 'id': id }, token).subscribe(
                    response => {
                        swal({
                            title: 'Eliminado!',
