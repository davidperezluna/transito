...
export class SvCfgMotivoAnulacionComponent implements OnInit {
    public errorMessage;
    public table: any;
    ...
    ngOnInit() {
        ...
        this._MotivoAnulacionService.index().subscribe(
            response => {
    ...
    onDelete(id: any) {
        swal({
            ...
            if (result.value) {
                ...
                this._MotivoAnulacionService.delete({ 'id': id }, token).subscribe(
                    response => {
                        swal({
                            title: 'Eliminado!',
