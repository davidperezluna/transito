...
export class SvCfgResultadoExamenComponent implements OnInit {
    public errorMessage;
    public table: any;
    ...
    ngOnInit() {
        ...
        this._ResultadoExamenService.index().subscribe(
            response => {
    ...
    onDelete(id: any) {
        swal({
            ...
            if (result.value) {
                ...
                this._ResultadoExamenService.delete({ 'id': id }, token).subscribe(
                    response => {
                        swal({
                            title: 'Eliminado!',
