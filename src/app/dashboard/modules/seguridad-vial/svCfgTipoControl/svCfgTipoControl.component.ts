...
export class SvCfgTipoControlComponent implements OnInit {
    public errorMessage;
    public table: any;
    public tiposControl;
    public respuesta;
    ...
    ngOnInit() {
        ...
        this._TipoControlService.index().subscribe(
            response => {
                this.tiposControl = response.data;
    ...
    onDelete(id: any) {
        swal({
            ...
            if (result.value) {
                ...
                this._TipoControlService.delete({ 'id': id }, token).subscribe(
                    response => {
                        swal({
                            title: 'Eliminado!',
