...
export class SvCfgIluminacionComponent implements OnInit {
    public errorMessage;
    public table: any;
    public iluminaciones;
    public respuesta;
    ...
    ngOnInit() {
        ...
        this._IluminacionService.index().subscribe(
            response => {
    ...
    onDelete(id: any) {
        swal({
            ...
            if (result.value) {
                ...
                this._IluminacionService.delete({ 'id': id }, token).subscribe(
                    response => {
                        swal({
                            title: 'Eliminado!',
