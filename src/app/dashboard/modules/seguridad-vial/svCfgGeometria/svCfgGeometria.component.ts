...
@Component({
    selector: 'app-index',
    templateUrl: './svCfgGeometria.component.html'
})
export class SvCfgGeometriaComponent implements OnInit {
    public errorMessage;
    public table: any;
    public geometrias;
    public respuesta;
    ...
    ngOnInit() {
        ...
        this._GeometriaService.index().subscribe(
            response => {
    ...
    onDelete(id: any) {
        swal({
            ...
            if (result.value) {
                ...
                this._GeometriaService.delete({ 'id': id }, token).subscribe(
                    response => {
                        swal({
                            title: 'Eliminado!',
