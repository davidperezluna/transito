...
@Component({
    selector: 'app-index',
    templateUrl: './svCfgMaterial.component.html'
})
export class SvCfgMaterialComponent implements OnInit {
    public errorMessage;
    public table: any;
    public materiales;
    public respuesta;
    ...
    ngOnInit() {
        ...
        this._MaterialService.index().subscribe(
            response => {
    ...
    onDelete(id: any) {
        swal({
            ...
            if (result.value) {
                ...
                this._MaterialService.delete({ 'id': id }, token).subscribe(
                    response => {
                        swal({
                            title: 'Eliminado!',
