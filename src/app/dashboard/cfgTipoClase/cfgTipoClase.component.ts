...
export class CfgTipoClaseComponent implements OnInit {
    public errorMessage;
    public id;
    public respuesta;
    public tiposVehiculoClase;
    ...
    ngOnInit() {
        ...
        this._TipoClaseService.index().subscribe(
            response => {
                this.tiposVehiculoClase = response.data;
    ...
    onDelete(id: any) {
        swal({
            ...
            if (result.value) {
                ...
                this._TipoClaseService.delete({'id':id}, token).subscribe(
                    response => {
                        swal({
                            title: 'Eliminado!',
