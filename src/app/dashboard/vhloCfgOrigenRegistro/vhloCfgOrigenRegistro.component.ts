...
export class VhloCfgOrigenRegistroComponent implements OnInit {
  public errorMessage;
	public id;
  ...
  ngOnInit() {
    ...
    this._OrigenRegistroService.index().subscribe(
				response => {
  ...
  onDelete(id:any){
    swal({
      ...
      if (result.value) {
        ...
        this._OrigenRegistroService.delete({'id':id},token).subscribe(
            response => {
                swal({
                      title: 'Eliminado!',
