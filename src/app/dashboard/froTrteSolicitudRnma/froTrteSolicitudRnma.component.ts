...
@Component({
  selector: 'app-index',
  templateUrl: './froTrteSolicitudRnma.component.html'
})
export class FroTrteSolicitudRnmaComponent implements OnInit {
  public tipo: any;
  public errorMessage;
	public id;
  ...
  public tramiteSolicitud: FroTrteSolicitudRnma;
