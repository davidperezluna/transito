...
@Component({
    selector: 'appRnrs-cambio-acreedor-prendario-propietario',
    templateUrl: './newRnrs.CambioAcreedorPrendarioPropietario.html'
})
export class NewRnrsTramiteCambioAcreedorPrendarioPropietarioComponent implements OnInit {
