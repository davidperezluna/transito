...
@Component({
    selector: 'appRnrs-importacion-temporal',
    templateUrl: './newRnrs.importacionTemporal.component.html',
    providers: [DatePipe]
})
export class NewRnrsImportacionTemporalComponent implements OnInit {
    ...
    enviarTramite() {
        ...
        this.datos.tramiteFormulario = 'rnrs-importacion-temporal';
