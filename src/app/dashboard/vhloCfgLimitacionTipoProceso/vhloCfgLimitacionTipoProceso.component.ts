...
@Component({
  selector: 'app-index',
  templateUrl: './vhloCfgLimitacionTipoProceso.component.html'
})
export class VhloCfgLimitacionTipoProcesoComponent implements OnInit {
  public errorMessage;
  ...
  ngOnInit() {
    ...
    this._CfgTipoProcesoService.index().subscribe(
				response => {
