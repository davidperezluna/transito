...
@Component({
    selector: 'app-cambio-acreedor-prendario',
    templateUrl: './new.CambioAcreedorPrendario.html'
})
export class NewTramiteCambioAcreedorPrendarioComponent implements OnInit {
