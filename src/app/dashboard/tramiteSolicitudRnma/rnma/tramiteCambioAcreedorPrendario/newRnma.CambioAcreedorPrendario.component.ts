...
@Component({
    selector: 'appRnma-cambio-acreedor-prendario',
    templateUrl: './newRnma.CambioAcreedorPrendario.html'
})
export class NewRnmaTramiteCambioAcreedorPrendarioComponent implements OnInit {
