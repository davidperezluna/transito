...
@Component({
    selector: 'appRnma-cambio-acreedor-prendario-propietario',
    templateUrl: './newRnma.CambioAcreedorPrendarioPropietario.html'
})
export class NewRnmaTramiteCambioAcreedorPrendarioPropietarioComponent implements OnInit {
