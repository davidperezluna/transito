...
@Component({
    selector: 'app-index',
    templateUrl: './froRecaudo.component.html',
})
export class FroRecaudoComponent implements OnInit {
    public errorMessage;
    public respuesta;
    public recaudos;
    ...
    constructor(
        private _AreaService: FroRecaudoService,
    ...
    editArea(froRecaudo: any) {
        this.froRecaudo = froRecaudo;
        this.formEdit = true;
        this.formIndex = false;
    }
}
