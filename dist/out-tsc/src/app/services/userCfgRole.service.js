...
var UserCfgRoleService = (function () {
    function UserCfgRoleService(_http, _loogerService) {
        this._http = _http;
        this._loogerService = _loogerService;
        this.url = environment_1.environment.apiUrl + 'usercfgrole';
    }
    UserCfgRoleService.prototype.index = function () {
        return this._http.get(this.url + "/").map(function (res) { return res.json(); });
    };
    UserCfgRoleService.prototype.register = function (datos, token) {
    ...
    UserCfgRoleService.prototype.select = function () {
        return this._http.get(this.url + "/select").map(function (res) { return res.json(); });
    };
    return UserCfgRoleService;
}());
UserCfgRoleService = __decorate([
    core_1.Injectable(),
    __metadata("design:paramtypes", [http_1.Http,
        logger_service_1.LoggerService])
], UserCfgRoleService);
exports.UserCfgRoleService = UserCfgRoleService;
//# sourceMappingURL=userCfgRole.service.js.map