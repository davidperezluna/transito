...
var LineaService = (function () {
    function LineaService(_http) {
        this._http = _http;
        this.url = environment_1.environment.apiUrl + "linea";
    }
    LineaService.prototype.index = function () {
        return this._http.get(this.url + "/").map(function (res) { return res.json(); });
    };
    LineaService.prototype.register = function (datos, token) {
