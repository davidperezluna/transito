...
var SvCfgUnidadReceptoraService = (function () {
    function SvCfgUnidadReceptoraService(_http, _loogerService) {
        this._http = _http;
        this._loogerService = _loogerService;
        this.url = environment_1.environment.apiUrl + 'seguridadvial/svcfgunidadreceptora';
    }
    SvCfgUnidadReceptoraService.prototype.index = function () {
        return this._http.get(this.url + "/").map(function (res) { return res.json(); });
    };
    SvCfgUnidadReceptoraService.prototype.register = function (datos, token) {
    ...
    SvCfgUnidadReceptoraService.prototype.delete = function (datos, token) {
        var json = JSON.stringify(datos);
        var params = "json=" + json + "&authorization=" + token;
        var headers = new http_1.Headers({ 'Content-Type': 'application/x-www-form-urlencoded' });
    ...
    SvCfgUnidadReceptoraService.prototype.show = function (datos, token) {
        var json = JSON.stringify(datos);
        var params = "json=" + json + "&authorization=" + token;
        var headers = new http_1.Headers({ 'Content-Type': 'application/x-www-form-urlencoded' });
        return this._http.post(this.url + "/show", params, { headers: headers }).map(function (res) { return res.json(); });
    };
    SvCfgUnidadReceptoraService.prototype.edit = function (datos, token) {
        var json = JSON.stringify(datos);
        var params = "json=" + json + "&authorization=" + token;
        var headers = new http_1.Headers({ 'Content-Type': 'application/x-www-form-urlencoded' });
    ...
    SvCfgUnidadReceptoraService.prototype.getUnidadReceptoraSelect = function () {
        return this._http.get(this.url + "/select").map(function (res) { return res.json(); });
    };
    return SvCfgUnidadReceptoraService;
}());
SvCfgUnidadReceptoraService = __decorate([
    core_1.Injectable(),
    __metadata("design:paramtypes", [http_1.Http,
        logger_service_1.LoggerService])
], SvCfgUnidadReceptoraService);
exports.SvCfgUnidadReceptoraService = SvCfgUnidadReceptoraService;
//# sourceMappingURL=svCfgUnidadReceptora.service.js.map