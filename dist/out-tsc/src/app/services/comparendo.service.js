...
var ComparendoService = /** @class */ (function () {
    function ComparendoService(_http) {
        this._http = _http;
        this.url = "http://localhost/GitHub/colossus-sit/web/app_dev.php/comparendo";
    }
    ComparendoService.prototype.getComparendo = function () {
        return this._http.get(this.url + "/").map(function (res) { return res.json(); });
    };
    ComparendoService.prototype.register = function (comparendo, token) {
    ...
    ComparendoService.prototype.editComparendo = function (comparendo, token) {
        var json = JSON.stringify(comparendo);
        var params = "json=" + json + "&authorization=" + token;
        var headers = new http_1.Headers({ 'Content-Type': 'application/x-www-form-urlencoded' });
    ...
    ComparendoService.prototype.getComparendoSelect = function () {
