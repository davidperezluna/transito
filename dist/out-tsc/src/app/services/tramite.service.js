...
var TramiteService = (function () {
    function TramiteService(_http) {
        this._http = _http;
        this.url = environment_1.environment.apiUrl + "tramite";
    }
    ...
    TramiteService.prototype.getTramiteSelect = function () {
        return this._http.get(this.url + "/select").map(function (res) { return res.json(); });
    };
    TramiteService.prototype.getTramitePorModuloSelect = function (id) {
        return this._http.get(this.url + "/" + id + "/select/tramites/por/modulo").map(function (res) { return res.json(); });
    };
