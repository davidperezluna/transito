...
var FacturaService = (function () {
    function FacturaService(_http) {
        this._http = _http;
        this.url = environment_1.environment.apiUrl + "factura";
    }
    FacturaService.prototype.getFactura = function () {
        return this._http.get(this.url + "/").map(function (res) { return res.json(); });
    };
    FacturaService.prototype.register = function (factura, token) {
    ...
    FacturaService.prototype.imprimir = function (factura, token) {
        var json = JSON.stringify(factura);
        var params = "json=" + json + "&authorization=" + token;
        var headers = new http_1.Headers({ 'Content-Type': 'application/x-www-form-urlencoded' });
    ...
    FacturaService.prototype.deleteFactura = function (token, id) {
        var params = "authorization=" + token;
        var headers = new http_1.Headers({ 'Content-Type': 'application/x-www-form-urlencoded' });
        return this._http.post(this.url + "/" + id + "/delete", params, { headers: headers })
            .map(function (res) { return res.json(); });
    };
    FacturaService.prototype.showFactura = function (token, id) {
        var params = "authorization=" + token;
        var headers = new http_1.Headers({ 'Content-Type': 'application/x-www-form-urlencoded' });
        return this._http.post(this.url + "/show/" + id, params, { headers: headers })
            .map(function (res) { return res.json(); });
    };
    FacturaService.prototype.showFacturaById = function (token, id) {
        var json = JSON.stringify(id);
        var params = 'json=' + json + '&authorization=' + token;
        var headers = new http_1.Headers({ 'Content-Type': 'application/x-www-form-urlencoded' });
        return this._http.post(this.url + '/show/id', params, { headers: headers }).map(function (res) { return res.json(); });
    };
    FacturaService.prototype.showFacturaByVehiculo = function (token, vehiculo) {
    ...
    FacturaService.prototype.editFactura = function (factura, token) {
        var json = JSON.stringify(factura);
        var params = "json=" + json + "&authorization=" + token;
        var headers = new http_1.Headers({ 'Content-Type': 'application/x-www-form-urlencoded' });
    ...
    FacturaService.prototype.getFacturaSelect = function () {
        return this._http.get(this.url + "/select").map(function (res) { return res.json(); });
    };
    FacturaService.prototype.searchByNumero = function (token, datos) {
