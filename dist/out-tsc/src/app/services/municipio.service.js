...
var MunicipioService = (function () {
    function MunicipioService(_http) {
        this._http = _http;
        this.url = environment_1.environment.apiUrl + "municipio";
    }
    ...
    MunicipioService.prototype.getMunicipioSelect = function () {
        return this._http.get(this.url + "/select").map(function (res) { return res.json(); });
    };
    MunicipioService.prototype.getMunicipioPorDepartamentoSelect = function (id) {
        return this._http.get(this.url + "/" + id + "/select/municipios/por/departamento").map(function (res) { return res.json(); });
    };
