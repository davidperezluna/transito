...
var EmpresaService = (function () {
    function EmpresaService(_http) {
        this._http = _http;
        this.url = environment_1.environment.apiUrl + "empresa";
    }
    ...
    EmpresaService.prototype.showNit = function (token, nit) {
        ...
        var params = "&authorization=" + token;
        var headers = new http_1.Headers({ 'Content-Type': 'application/x-www-form-urlencoded' });
        return this._http.post(this.url + "/show/empresa/" + nit, params, { headers: headers })
            .map(function (res) { return res.json(); });
    };
    EmpresaService.prototype.showNitOrNombre = function (token, parametro) {
    ...
    EmpresaService.prototype.getEmpresaSelect = function () {
