...
var MflInfraccionService = (function () {
    function MflInfraccionService(_http, _loogerService) {
        this._http = _http;
        this._loogerService = _loogerService;
        this.url = environment_1.environment.apiUrl + "mflinfraccion";
    }
    MflInfraccionService.prototype.index = function () {
        return this._http.get(this.url + "/").map(function (res) { return res.json(); });
    };
    MflInfraccionService.prototype.register = function (datos, token) {
    ...
    MflInfraccionService.prototype.select = function () {
        return this._http.get(this.url + "/select").map(function (res) { return res.json(); });
    };
    MflInfraccionService.prototype.calculateValue = function (datos, token) {
        var json = JSON.stringify(datos);
        var params = "json=" + json + "&authorization=" + token;
        var headers = new http_1.Headers({ 'Content-Type': 'application/x-www-form-urlencoded' });
        return this._http.post(this.url + "/calculate/value", params, { headers: headers }).map(function (res) { return res.json(); });
    };
    return MflInfraccionService;
}());
MflInfraccionService = __decorate([
    core_1.Injectable(),
    __metadata("design:paramtypes", [http_1.Http,
        logger_service_1.LoggerService])
], MflInfraccionService);
exports.MflInfraccionService = MflInfraccionService;
//# sourceMappingURL=mflInfraccion.service.js.map