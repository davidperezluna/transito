...
var UsuarioService = (function () {
    function UsuarioService(_http) {
        this._http = _http;
        this.url = environment_1.environment.apiUrl + "usuario";
    }
    UsuarioService.prototype.getUsuario = function () {
        return this._http.get(this.url + "/").map(function (res) { return res.json(); });
    };
    UsuarioService.prototype.register = function (tipoCorrespondencia, token) {
    ...
    UsuarioService.prototype.editUsuario = function (tipoCorrespondencia, token) {
        var json = JSON.stringify(tipoCorrespondencia);
        var params = "json=" + json + "&authorization=" + token;
        var headers = new http_1.Headers({ 'Content-Type': 'application/x-www-form-urlencoded' });
        return this._http.post(this.url + "/edit", params, { headers: headers }).map(function (res) { return res.json(); });
    };
    UsuarioService.prototype.getUsuarioSelect = function () {
