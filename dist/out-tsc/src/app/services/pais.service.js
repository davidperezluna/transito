...
var PaisService = (function () {
    function PaisService(_http) {
        this._http = _http;
        this.url = environment_1.environment.apiUrl + "pais";
    }
    PaisService.prototype.getPais = function () {
        return this._http.get(this.url + "/").map(function (res) { return res.json(); });
    };
    PaisService.prototype.register = function (pais, token) {
