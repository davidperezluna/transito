...
var TipoEmpresaService = (function () {
    function TipoEmpresaService(_http) {
        this._http = _http;
        this.url = environment_1.environment.apiUrl + "tipoEmpresa";
    }
    TipoEmpresaService.prototype.getTipoEmpresa = function () {
        return this._http.get(this.url + "/").map(function (res) { return res.json(); });
    };
    TipoEmpresaService.prototype.register = function (tipoDocumento, token) {
    ...
    TipoEmpresaService.prototype.editTipoEmpresa = function (tipoDocumento, token) {
        var json = JSON.stringify(tipoDocumento);
        var params = "json=" + json + "&authorization=" + token;
        var headers = new http_1.Headers({ 'Content-Type': 'application/x-www-form-urlencoded' });
    ...
    TipoEmpresaService.prototype.getTipoEmpresaSelect = function () {
