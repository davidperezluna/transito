...
var InfraccionService = (function () {
    function InfraccionService(_http) {
        this._http = _http;
        this.url = environment_1.environment.apiUrl + "infraccion";
    }
    InfraccionService.prototype.getInfraccion = function () {
        return this._http.get(this.url + "/").map(function (res) { return res.json(); });
    };
    InfraccionService.prototype.register = function (infraccion, token) {
        var json = JSON.stringify(infraccion);
        var params = "json=" + json + "&authorization=" + token;
        var headers = new http_1.Headers({ 'Content-Type': 'application/x-www-form-urlencoded' });
        return this._http.post(this.url + "/new", params, { headers: headers }).map(function (res) { return res.json(); });
    };
    InfraccionService.prototype.deleteInfraccion = function (token, id) {
        var params = "authorization=" + token;
        var headers = new http_1.Headers({ 'Content-Type': 'application/x-www-form-urlencoded' });
        return this._http.post(this.url + "/" + id + "/delete", params, { headers: headers }).map(function (res) { return res.json(); });
    };
    InfraccionService.prototype.showInfraccion = function (token, id) {
        var params = "authorization=" + token;
        var headers = new http_1.Headers({ 'Content-Type': 'application/x-www-form-urlencoded' });
        return this._http.post(this.url + "/show/" + id, params, { headers: headers }).map(function (res) { return res.json(); });
    };
    // tslint:disable-next-line:one-line
    InfraccionService.prototype.editInfraccion = function (infraccion, token) {
        var json = JSON.stringify(infraccion);
        var params = "json=" + json + "&authorization=" + token;
        var headers = new http_1.Headers({ 'Content-Type': 'application/x-www-form-urlencoded' });
        return this._http.post(this.url + "/edit", params, { headers: headers }).map(function (res) { return res.json(); });
    };
    InfraccionService.prototype.getInfraccionSelect = function () {
