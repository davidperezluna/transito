...
var ParametroService = (function () {
    function ParametroService(_http) {
        this._http = _http;
        this.url = environment_1.environment.apiUrl + "parametro";
    }
    ParametroService.prototype.getParametro = function () {
        return this._http.get(this.url + "/").map(function (res) { return res.json(); });
    };
    ParametroService.prototype.register = function (parametro, token) {
