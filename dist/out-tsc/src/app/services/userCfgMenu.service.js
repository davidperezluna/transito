...
var UserCfgMenuService = (function () {
    function UserCfgMenuService(_http, _loogerService) {
        this._http = _http;
        this._loogerService = _loogerService;
        this.url = environment_1.environment.apiUrl + 'usercfgmenu';
    }
    UserCfgMenuService.prototype.index = function () {
        return this._http.get(this.url + "/").map(function (res) { return res.json(); });
    };
    UserCfgMenuService.prototype.register = function (datos, token) {
    ...
    UserCfgMenuService.prototype.select = function () {
        return this._http.get(this.url + "/select").map(function (res) { return res.json(); });
    };
    UserCfgMenuService.prototype.list = function () {
        return this._http.get(this.url + "/list").map(function (res) { return res.json(); });
    };
    return UserCfgMenuService;
}());
UserCfgMenuService = __decorate([
    core_1.Injectable(),
    __metadata("design:paramtypes", [http_1.Http,
        logger_service_1.LoggerService])
], UserCfgMenuService);
exports.UserCfgMenuService = UserCfgMenuService;
//# sourceMappingURL=userCfgMenu.service.js.map