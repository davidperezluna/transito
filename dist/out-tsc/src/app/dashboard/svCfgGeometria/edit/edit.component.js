...
var EditComponent = (function () {
    function EditComponent(_GeometriaService, _loginService, _TipoGeometriaService) {
    ...
    EditComponent.prototype.ngOnInit = function () {
        ...
        this._TipoGeometriaService.getTipoGeometriaSelect().subscribe(function (response) {
            ...
            setTimeout(function () {
                _this.tipoGeometriaSelected = [_this.geometria.tipoGeometria.id];
            });
        }, function (error) {
    ...
    EditComponent.prototype.onEnviar = function () {
        ...
        this._GeometriaService.edit(this.geometria, token).subscribe(function (response) {
...
__decorate([
    core_1.Input(),
    __metadata("design:type", Object)
], EditComponent.prototype, "geometria", void 0);
