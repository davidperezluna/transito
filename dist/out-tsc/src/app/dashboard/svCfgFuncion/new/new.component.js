...
var NewComponent = (function () {
    function NewComponent(_FuncionService, _loginService) {
    ...
    NewComponent.prototype.ngOnInit = function () {
        this.funcion = new svCfgFuncion_modelo_1.SvCfgFuncion(null, null);
    };
    ...
    NewComponent.prototype.onEnviar = function () {
        ...
        this._FuncionService.register(this.funcion, token).subscribe(function (response) {
