...
var tipoIdentificacion_modelo_1 = require("../tipoIdentificacion.modelo");
var tipoIdentificacion_service_1 = require("../../../services/tipoIdentificacion.service");
var login_service_1 = require("../../../services/login.service");
var sweetalert2_1 = require("sweetalert2");
var NewComponent = (function () {
    function NewComponent(_TipoIdentificacionService, _loginService) {
        this._TipoIdentificacionService = _TipoIdentificacionService;
        this._loginService = _loginService;
        this.ready = new core_1.EventEmitter();
    }
    NewComponent.prototype.ngOnInit = function () {
        this.tipoIdentificacion = new tipoIdentificacion_modelo_1.TipoIdentificacion(null, null, null);
    };
