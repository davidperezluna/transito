...
var NewComponent = (function () {
    function NewComponent(GruaService, _loginService) {
    ...
    NewComponent.prototype.onEnviar = function () {
        ...
        this.GruaService.register(this.gruaCiudadano, token).subscribe(function (response) {
...
__decorate([
    core_1.Input(),
    __metadata("design:type", Object)
], NewComponent.prototype, "grua", void 0);
