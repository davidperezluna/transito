...
var EditComponent = (function () {
    function EditComponent(_infraccionService, _loginService) {
    ...
    EditComponent.prototype.ngOnInit = function () { console.log(this.infraccion); };
    EditComponent.prototype.onCancelar = function () { this.ready.emit(true); };
    EditComponent.prototype.onEnviar = function () {
        var _this = this;
        var token = this._loginService.getToken();
        this._infraccionService.editInfraccion(this.infraccion, token).subscribe(function (response) {
