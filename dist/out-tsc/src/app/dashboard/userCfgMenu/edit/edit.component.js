...
var EditComponent = (function () {
    function EditComponent(_UserCfgMenuService, _loginService) {
    ...
    EditComponent.prototype.onEnviar = function () {
        ...
        this._UserCfgMenuService.edit(this.menu, token).subscribe(function (response) {
...
__decorate([
    core_1.Input(),
    __metadata("design:type", Object)
], EditComponent.prototype, "menu", void 0);
