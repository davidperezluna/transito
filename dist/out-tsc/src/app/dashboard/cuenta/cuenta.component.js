...
var CuentaComponent = /** @class */ (function () {
    function CuentaComponent(_CuentaService, _loginService) {
    ...
    CuentaComponent.prototype.iniciarTabla = function () {
    ...
    CuentaComponent.prototype.onNew = function () {
        this.formNew = true;
        this.formIndex = false;
        this.table.destroy();
    };
    CuentaComponent.prototype.ready = function (isCreado) {
        if (isCreado) {
            this.formNew = false;
            this.formEdit = false;
            this.formIndex = true;
    ...
    CuentaComponent.prototype.deleteCuenta = function (id) {
        var _this = this;
        sweetalert2_1.default({
            title: '¿Estás seguro?',
            ...
            if (result.value) {
                ...
                _this._CuentaService.deleteCuenta(token, id).subscribe(function (response) {
                    sweetalert2_1.default({
                        title: 'Eliminado!',
    ...
    CuentaComponent.prototype.editCuenta = function (cuenta) {
        this.cuenta = cuenta;
        this.formEdit = true;
        this.formIndex = false;
    };
