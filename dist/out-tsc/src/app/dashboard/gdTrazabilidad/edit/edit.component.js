...
var EditComponent = (function () {
    ...
    function EditComponent(_PeticionarioService, _loginService) {
        this._PeticionarioService = _PeticionarioService;
    ...
    EditComponent.prototype.onEnviar = function () {
        ...
        this._PeticionarioService.edit(this.peticionario, token).subscribe(function (response) {
...
__decorate([
    core_1.Input(),
    __metadata("design:type", Object)
], EditComponent.prototype, "peticionario", void 0);
