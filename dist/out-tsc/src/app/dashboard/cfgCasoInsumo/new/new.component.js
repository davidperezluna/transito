...
var cfgCasoInsumo_modelo_1 = require("../cfgCasoInsumo.modelo");
...
var NewComponent = (function () {
    function NewComponent(_CfgCasoInsumoService, _loginService, _ModuloService, _sedeOperativaService) {
    ...
    NewComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.cfgCasoInsumo = new cfgCasoInsumo_modelo_1.CfgCasoInsumo(null, null, null, null, null, null);
    ...
    NewComponent.prototype.onEnviar = function () {
        ...
        this._CfgCasoInsumoService.register(this.cfgCasoInsumo, token).subscribe(function (response) {
