...
var NewRnrsCiudadanoComponent = (function () {
    function NewRnrsCiudadanoComponent(_CiudadanoService, _loginService, _tipoIdentificacionService, _generoService, _grupoSanguineoService, _municipioService) {
    ...
    NewRnrsCiudadanoComponent.prototype.ngOnInit = function () {
        var _this = this;
    ...
    NewRnrsCiudadanoComponent.prototype.onCancelar = function () {
        this.ready.emit(false);
    };
    NewRnrsCiudadanoComponent.prototype.onEnviar = function () {
        var _this = this;
    ...
    return NewRnrsCiudadanoComponent;
}());
__decorate([
    core_1.Output(),
    __metadata("design:type", Object)
], NewRnrsCiudadanoComponent.prototype, "ready", void 0);
__decorate([
    core_1.Input(),
    __metadata("design:type", Object)
], NewRnrsCiudadanoComponent.prototype, "identificacion", void 0);
__decorate([
    core_1.Input(),
    __metadata("design:type", Object)
], NewRnrsCiudadanoComponent.prototype, "tipoIdentificacion", void 0);
NewRnrsCiudadanoComponent = __decorate([
    core_1.Component({
        selector: 'app-new-rnrs-ciudadano',
        templateUrl: './newRnrsCiudadano.component.html'
    }),
...
exports.NewRnrsCiudadanoComponent = NewRnrsCiudadanoComponent;
//# sourceMappingURL=newRnrsCiudadano.component.js.map