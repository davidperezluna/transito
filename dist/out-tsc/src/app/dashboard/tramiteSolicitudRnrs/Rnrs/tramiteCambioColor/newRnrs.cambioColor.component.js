...
var NewRnrsCambioColorComponent = (function () {
    function NewRnrsCambioColorComponent(_ColorService, _TramiteSolicitudService, _loginService, _tramiteFacturaService, _VehiculoService) {
    ...
    NewRnrsCambioColorComponent.prototype.ngOnInit = function () {
        var _this = this;
    ...
    NewRnrsCambioColorComponent.prototype.enviarTramite = function () {
        var _this = this;
        var token = this._loginService.getToken();
        this._ColorService.show(token, this.colorSelected).subscribe(function (color) {
            ...
            _this._VehiculoService.editVehiculoColor(_this.vehiculo, token).subscribe(function (response) {
                ...
                if (_this.respuesta.status == 'success') {
                    ...
                    _this.datos.tramiteFormulario = 'rnrs-cambiocolor';
    ...
    NewRnrsCambioColorComponent.prototype.onCancelar = function () {
        this.cancelarTramite.emit(true);
    };
    return NewRnrsCambioColorComponent;
}());
__decorate([
    core_1.Output(),
    __metadata("design:type", Object)
], NewRnrsCambioColorComponent.prototype, "readyTramite", void 0);
__decorate([
    core_1.Output(),
    __metadata("design:type", Object)
], NewRnrsCambioColorComponent.prototype, "cancelarTramite", void 0);
__decorate([
    core_1.Input(),
    __metadata("design:type", Object)
], NewRnrsCambioColorComponent.prototype, "vehiculo", void 0);
__decorate([
    core_1.Input(),
    __metadata("design:type", Object)
], NewRnrsCambioColorComponent.prototype, "tramitesFactura", void 0);
__decorate([
    core_1.Input(),
    __metadata("design:type", Object)
], NewRnrsCambioColorComponent.prototype, "factura", void 0);
NewRnrsCambioColorComponent = __decorate([
    core_1.Component({
...
exports.NewRnrsCambioColorComponent = NewRnrsCambioColorComponent;
//# sourceMappingURL=newRnrs.cambioColor.component.js.map