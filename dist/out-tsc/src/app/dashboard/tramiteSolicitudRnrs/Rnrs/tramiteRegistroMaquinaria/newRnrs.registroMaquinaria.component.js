...
var newRnrs_registroMaquinaria_modelo_1 = require("./newRnrs.registroMaquinaria.modelo");
...
var NewRnrsRegistroMaquinariaComponent = (function () {
    function NewRnrsRegistroMaquinariaComponent(_loginService, _lineaService, _ClaseService, _CarroceriaService, _ColorService, _CombustibleService, _VehiculoService, _MarcaService, _TramiteFacturaService, _TipoVehiculoService) {
    ...
    NewRnrsRegistroMaquinariaComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.registroMaquinaria = new newRnrs_registroMaquinaria_modelo_1.RegistroMaquinaria(null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
    ...
    NewRnrsRegistroMaquinariaComponent.prototype.onCancelar = function () {
        this.cancelarTramite.emit(true);
    };
    NewRnrsRegistroMaquinariaComponent.prototype.onEnviar = function () {
        var _this = this;
        ...
        this._VehiculoService.register(this.vehiculo, token).subscribe(function (response) {
            ...
            if (_this.respuesta.status == 'success') {
                ...
                _this.datos.tramiteFormulario = 'rnrs-registromaquinaria';
    ...
    NewRnrsRegistroMaquinariaComponent.prototype.changedDepartamento = function (e) {
        var _this = this;
    ...
    return NewRnrsRegistroMaquinariaComponent;
}());
__decorate([
    core_1.Output(),
    __metadata("design:type", Object)
], NewRnrsRegistroMaquinariaComponent.prototype, "readyTramite", void 0);
__decorate([
    core_1.Output(),
    __metadata("design:type", Object)
], NewRnrsRegistroMaquinariaComponent.prototype, "cancelarTramite", void 0);
__decorate([
    core_1.Input(),
    __metadata("design:type", Object)
], NewRnrsRegistroMaquinariaComponent.prototype, "vehiculo", void 0);
__decorate([
    core_1.Input(),
    __metadata("design:type", Object)
], NewRnrsRegistroMaquinariaComponent.prototype, "factura", void 0);
__decorate([
    core_1.Input(),
    __metadata("design:type", Object)
], NewRnrsRegistroMaquinariaComponent.prototype, "tramitesFactura", void 0);
NewRnrsRegistroMaquinariaComponent = __decorate([
    core_1.Component({
...
exports.NewRnrsRegistroMaquinariaComponent = NewRnrsRegistroMaquinariaComponent;
//# sourceMappingURL=newRnrs.registroMaquinaria.component.js.map