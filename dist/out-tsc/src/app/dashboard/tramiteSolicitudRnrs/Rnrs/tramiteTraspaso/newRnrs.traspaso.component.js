...
var NewRnrsTraspasoComponent = (function () {
    function NewRnrsTraspasoComponent(_ColorService, _TramiteSolicitudService, _loginService, _tramiteFacturaService, _VehiculoService, _tipoIdentificacionService, _CiudadanoService, _CiudadanoVehiculoService, router, _EmpresaService) {
    ...
    NewRnrsTraspasoComponent.prototype.ngOnInit = function () {
        var _this = this;
    ...
    NewRnrsTraspasoComponent.prototype.enviarTramite = function () {
        var _this = this;
        ...
        this._CiudadanoVehiculoService.register(token, this.datos, this.tipoPropiedadSelected).subscribe(function (response) {
            ...
            _this.datos.tramiteFormulario = 'rnrs-traspaso';
    ...
    NewRnrsTraspasoComponent.prototype.onCancelar = function () {
        this.cancelarTramite.emit(true);
    };
    NewRnrsTraspasoComponent.prototype.onKeyCiudadano = function () {
        var _this = this;
        var token = this._loginService.getToken();
        var identificacion = {
    ...
    NewRnrsTraspasoComponent.prototype.onKeyApoderado = function () {
        var _this = this;
        var token = this._loginService.getToken();
        var identificacion = {
    ...
    NewRnrsTraspasoComponent.prototype.onKeyEmpresa = function () {
        var _this = this;
        var token = this._loginService.getToken();
        var nit = {
            'nit': this.nit,
    ...
    NewRnrsTraspasoComponent.prototype.goEmpresa = function () {
        this.router.navigate(['/dashboard/empresa']);
    };
    NewRnrsTraspasoComponent.prototype.btnNewCiudadano = function () {
    ...
    NewRnrsTraspasoComponent.prototype.btnNewEmpresa = function () {
        if (this.tipoPropiedadSelected == 2) {
    ...
    NewRnrsTraspasoComponent.prototype.btnNewApoderado = function () {
        var _this = this;
    ...
    NewRnrsTraspasoComponent.prototype.changedtipoIdentificacion = function (e) {
        this.ciudadanoEncontrado = 1;
        this.empresaEncontrada = 1;
    };
    NewRnrsTraspasoComponent.prototype.btnCancelarCiudadano = function () {
        this.ciudadanoEncontrado = 1;
    };
    NewRnrsTraspasoComponent.prototype.btnCancelarEmpresa = function () {
        this.empresaEncontrada = 1;
    };
    NewRnrsTraspasoComponent.prototype.delete = function (ciudadano) {
    ...
    NewRnrsTraspasoComponent.prototype.deleteEmpresa = function (empresa) {
    ...
    NewRnrsTraspasoComponent.prototype.ready = function (isCreado) {
        if (isCreado) {
    ...
    NewRnrsTraspasoComponent.prototype.agregarApoderadoCiudadano = function (ciudadano) {
        this.apoderado = 'ciudadano';
        this.ciudadanoSelected = this.datos.propietariosCiudadanos.filter(function (h) { return h == ciudadano; });
    };
    NewRnrsTraspasoComponent.prototype.agregarApoderadoEmpresa = function (empresa) {
        this.apoderado = 'empresa';
        this.empresaSelected = this.datos.propietariosEmpresas.filter(function (h) { return h == empresa; });
    };
    NewRnrsTraspasoComponent.prototype.onCancelarApoderado = function () {
        this.apoderado = 'false';
        this.tipoIdentificacionSelected = [this.tipoIdentificacionSelected];
    };
    return NewRnrsTraspasoComponent;
}());
__decorate([
    core_1.Output(),
    __metadata("design:type", Object)
], NewRnrsTraspasoComponent.prototype, "readyTramite", void 0);
__decorate([
    core_1.Output(),
    __metadata("design:type", Object)
], NewRnrsTraspasoComponent.prototype, "cancelarTramite", void 0);
__decorate([
    core_1.Input(),
    __metadata("design:type", Object)
], NewRnrsTraspasoComponent.prototype, "vehiculo", void 0);
__decorate([
    core_1.Input(),
    __metadata("design:type", Object)
], NewRnrsTraspasoComponent.prototype, "factura", void 0);
NewRnrsTraspasoComponent = __decorate([
    core_1.Component({
        selector: 'appRnrs-traspaso',
        templateUrl: './newRnrs.traspaso.html',
    }),
...
exports.NewRnrsTraspasoComponent = NewRnrsTraspasoComponent;
//# sourceMappingURL=newRnrs.traspaso.component.js.map