...
var NewRnrsRegrabarVinComponent = (function () {
    function NewRnrsRegrabarVinComponent(_TramiteSolicitudService, _loginService, _SustratoService, _VehiculoService) {
    ...
    NewRnrsRegrabarVinComponent.prototype.ngOnInit = function () {
        var _this = this;
    ...
    NewRnrsRegrabarVinComponent.prototype.ready = function (e) {
    };
    NewRnrsRegrabarVinComponent.prototype.enviarTramite = function () {
        var _this = this;
        ...
        this._VehiculoService.editVehiculo(this.vehiculo, token).subscribe(function (response) {
            ...
            if (_this.respuesta.status == 'success') {
                ...
                _this.datos.tramiteFormulario = 'rnrs-regrabarvin';
    ...
    NewRnrsRegrabarVinComponent.prototype.onCancelar = function () {
        this.cancelarTramite.emit(true);
    };
    return NewRnrsRegrabarVinComponent;
}());
__decorate([
    core_1.Output(),
    __metadata("design:type", Object)
], NewRnrsRegrabarVinComponent.prototype, "readyTramite", void 0);
__decorate([
    core_1.Output(),
    __metadata("design:type", Object)
], NewRnrsRegrabarVinComponent.prototype, "cancelarTramite", void 0);
__decorate([
    core_1.Input(),
    __metadata("design:type", Object)
], NewRnrsRegrabarVinComponent.prototype, "vehiculo", void 0);
__decorate([
    core_1.Input(),
    __metadata("design:type", Object)
], NewRnrsRegrabarVinComponent.prototype, "factura", void 0);
NewRnrsRegrabarVinComponent = __decorate([
    core_1.Component({
        selector: 'appRnrs-regrabar-vin',
        templateUrl: './newRnrs.regrabarVin.html'
    }),
...
exports.NewRnrsRegrabarVinComponent = NewRnrsRegrabarVinComponent;
//# sourceMappingURL=newRnrs.regrabarVin.component.js.map