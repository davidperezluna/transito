...
var NewRnrsTramiteInscripcionAlertaPrendaComponent = (function () {
    function NewRnrsTramiteInscripcionAlertaPrendaComponent(_CfgTipoAlertaService, _TramiteSolicitudService, _BancoService, _loginService, _tramiteFacturaService, _VehiculoService, _VehiculoAcreedorService, _tipoIdentificacionService, _CiudadanoService, router, _EmpresaService) {
    ...
    NewRnrsTramiteInscripcionAlertaPrendaComponent.prototype.ngOnInit = function () {
        var _this = this;
    ...
    NewRnrsTramiteInscripcionAlertaPrendaComponent.prototype.enviarTramite = function () {
        var _this = this;
    ...
    NewRnrsTramiteInscripcionAlertaPrendaComponent.prototype.onCancelar = function () {
    ...
    //     )
    // }
    NewRnrsTramiteInscripcionAlertaPrendaComponent.prototype.onKeyAcreedor = function () {
        var _this = this;
        var token = this._loginService.getToken();
        var nombreAcreedor = {
    ...
    NewRnrsTramiteInscripcionAlertaPrendaComponent.prototype.onKeyCiudadano = function () {
        var _this = this;
        var token = this._loginService.getToken();
        var identificacion = {
    ...
    NewRnrsTramiteInscripcionAlertaPrendaComponent.prototype.onKeyApoderado = function () {
        var _this = this;
        var token = this._loginService.getToken();
        var identificacion = {
    ...
    NewRnrsTramiteInscripcionAlertaPrendaComponent.prototype.onKeyEmpresa = function () {
        var _this = this;
        var token = this._loginService.getToken();
        var nit = {
            'nit': this.nit,
    ...
    NewRnrsTramiteInscripcionAlertaPrendaComponent.prototype.goEmpresa = function () {
        this.router.navigate(['/dashboard/empresa']);
    };
    NewRnrsTramiteInscripcionAlertaPrendaComponent.prototype.btnCancelarAcreedor = function () {
        this.acreedorEncontrado = 1;
    };
    NewRnrsTramiteInscripcionAlertaPrendaComponent.prototype.btnNewCiudadano = function () {
    ...
    NewRnrsTramiteInscripcionAlertaPrendaComponent.prototype.btnNewEmpresa = function () {
    ...
    NewRnrsTramiteInscripcionAlertaPrendaComponent.prototype.btnNewAcreedor = function () {
        var _this = this;
    ...
    NewRnrsTramiteInscripcionAlertaPrendaComponent.prototype.changedtipoIdentificacion = function (e) {
        this.ciudadanoEncontrado = 1;
        this.empresaEncontrada = 1;
    };
    NewRnrsTramiteInscripcionAlertaPrendaComponent.prototype.delete = function (acreedor) {
    ...
    NewRnrsTramiteInscripcionAlertaPrendaComponent.prototype.deleteEmpresa = function (empresa) {
    ...
    NewRnrsTramiteInscripcionAlertaPrendaComponent.prototype.ready = function (isCreado) {
        if (isCreado) {
    ...
    NewRnrsTramiteInscripcionAlertaPrendaComponent.prototype.btnCancelarCiudadano = function () {
        this.ciudadanoEncontrado = 1;
    };
    NewRnrsTramiteInscripcionAlertaPrendaComponent.prototype.btnCancelarEmpresa = function () {
        this.empresaEncontrada = 1;
    };
    return NewRnrsTramiteInscripcionAlertaPrendaComponent;
}());
__decorate([
    core_1.Output(),
    __metadata("design:type", Object)
], NewRnrsTramiteInscripcionAlertaPrendaComponent.prototype, "readyTramite", void 0);
__decorate([
    core_1.Output(),
    __metadata("design:type", Object)
], NewRnrsTramiteInscripcionAlertaPrendaComponent.prototype, "cancelarTramite", void 0);
__decorate([
    core_1.Input(),
    __metadata("design:type", Object)
], NewRnrsTramiteInscripcionAlertaPrendaComponent.prototype, "vehiculo", void 0);
__decorate([
    core_1.Input(),
    __metadata("design:type", Object)
], NewRnrsTramiteInscripcionAlertaPrendaComponent.prototype, "banco", void 0);
__decorate([
    core_1.Input(),
    __metadata("design:type", Object)
], NewRnrsTramiteInscripcionAlertaPrendaComponent.prototype, "factura", void 0);
__decorate([
    core_1.Input(),
    __metadata("design:type", Object)
], NewRnrsTramiteInscripcionAlertaPrendaComponent.prototype, "tramitesFactura", void 0);
NewRnrsTramiteInscripcionAlertaPrendaComponent = __decorate([
    core_1.Component({
        selector: 'appRnrs-inscripcion-alerta-prenda',
        templateUrl: './newRnrs.inscripcionAlertaPrenda.html'
    }),
...
exports.NewRnrsTramiteInscripcionAlertaPrendaComponent = NewRnrsTramiteInscripcionAlertaPrendaComponent;
//# sourceMappingURL=newRnrs.inscripcionAlertaPrenda.component.js.map