...
var NewRnrsCambioCarroceriaComponent = (function () {
    function NewRnrsCambioCarroceriaComponent(_CarroceriaService, _TramiteSolicitudService, _loginService, _VehiculoService) {
    ...
    NewRnrsCambioCarroceriaComponent.prototype.ngOnInit = function () {
        var _this = this;
    ...
    NewRnrsCambioCarroceriaComponent.prototype.enviarTramite = function () {
        var _this = this;
        ...
        this._CarroceriaService.showCarroceria(token, this.carroceriaSelected).subscribe(function (carroceria) {
            ...
            _this._VehiculoService.editVehiculo(_this.vehiculo, token).subscribe(function (response) {
                ...
                if (_this.respuesta.status == 'success') {
                    ...
                    _this.datos.tramiteFormulario = 'rnrs-cambiocarroceria';
    ...
    NewRnrsCambioCarroceriaComponent.prototype.onCancelar = function () {
        this.cancelarTramite.emit(true);
    };
    return NewRnrsCambioCarroceriaComponent;
}());
__decorate([
    core_1.Output(),
    __metadata("design:type", Object)
], NewRnrsCambioCarroceriaComponent.prototype, "readyTramite", void 0);
__decorate([
    core_1.Output(),
    __metadata("design:type", Object)
], NewRnrsCambioCarroceriaComponent.prototype, "cancelarTramite", void 0);
__decorate([
    core_1.Input(),
    __metadata("design:type", Object)
], NewRnrsCambioCarroceriaComponent.prototype, "vehiculo", void 0);
__decorate([
    core_1.Input(),
    __metadata("design:type", Object)
], NewRnrsCambioCarroceriaComponent.prototype, "factura", void 0);
NewRnrsCambioCarroceriaComponent = __decorate([
    core_1.Component({
...
exports.NewRnrsCambioCarroceriaComponent = NewRnrsCambioCarroceriaComponent;
//# sourceMappingURL=newRnrs.cambioCarroceria.component.js.map