...
var NewRnrsCambioConjuntoComponent = (function () {
    function NewRnrsCambioConjuntoComponent(_CombustibleService, _TramiteSolicitudService, _loginService, _VehiculoService) {
    ...
    NewRnrsCambioConjuntoComponent.prototype.ngOnInit = function () {
    };
    NewRnrsCambioConjuntoComponent.prototype.enviarTramite = function () {
        var _this = this;
        ...
        this._VehiculoService.editVehiculo(this.vehiculo, token).subscribe(function (response) {
            ...
            if (_this.respuesta.status == 'success') {
                ...
                _this.datos.tramiteFormulario = 'rnrs-cambioconjunto';
    ...
    NewRnrsCambioConjuntoComponent.prototype.onCancelar = function () {
        this.cancelarTramite.emit(true);
    };
    return NewRnrsCambioConjuntoComponent;
}());
__decorate([
    core_1.Output(),
    __metadata("design:type", Object)
], NewRnrsCambioConjuntoComponent.prototype, "readyTramite", void 0);
__decorate([
    core_1.Output(),
    __metadata("design:type", Object)
], NewRnrsCambioConjuntoComponent.prototype, "cancelarTramite", void 0);
__decorate([
    core_1.Input(),
    __metadata("design:type", Object)
], NewRnrsCambioConjuntoComponent.prototype, "vehiculo", void 0);
__decorate([
    core_1.Input(),
    __metadata("design:type", Object)
], NewRnrsCambioConjuntoComponent.prototype, "factura", void 0);
NewRnrsCambioConjuntoComponent = __decorate([
    core_1.Component({
        selector: 'appRnrs-cambioConjunto',
        templateUrl: './newRnrs.cambioConjunto.html'
    }),
...
exports.NewRnrsCambioConjuntoComponent = NewRnrsCambioConjuntoComponent;
//# sourceMappingURL=newRnrs.cambioConjunto.component.js.map