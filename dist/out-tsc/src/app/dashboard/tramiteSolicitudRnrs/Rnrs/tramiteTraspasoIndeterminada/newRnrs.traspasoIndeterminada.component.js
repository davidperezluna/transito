...
var NewRnrsTraspasoIndeterminadaComponent = (function () {
    function NewRnrsTraspasoIndeterminadaComponent(_TramiteSolicitudService, _loginService, _VehiculoService, _CiudadanoVehiculoService) {
    ...
    NewRnrsTraspasoIndeterminadaComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.datos = {
            'fecha': null,
    ...
    NewRnrsTraspasoIndeterminadaComponent.prototype.onNew = function () {
        this.formNew = true;
        this.formIndex = false;
        this.table.destroy();
    };
    NewRnrsTraspasoIndeterminadaComponent.prototype.ready = function (isCreado) {
        if (isCreado) {
            this.formNew = false;
            this.formEdit = false;
            this.formIndex = true;
    ...
    NewRnrsTraspasoIndeterminadaComponent.prototype.onEnviar = function () {
        var _this = this;
    ...
    return NewRnrsTraspasoIndeterminadaComponent;
}());
__decorate([
    core_1.Output(),
    __metadata("design:type", Object)
], NewRnrsTraspasoIndeterminadaComponent.prototype, "readyTramite", void 0);
__decorate([
    core_1.Input(),
    __metadata("design:type", Object)
], NewRnrsTraspasoIndeterminadaComponent.prototype, "vehiculo", void 0);
__decorate([
    core_1.Input(),
    __metadata("design:type", Object)
], NewRnrsTraspasoIndeterminadaComponent.prototype, "factura", void 0);
__decorate([
    core_1.Input(),
    __metadata("design:type", Object)
], NewRnrsTraspasoIndeterminadaComponent.prototype, "ciudadano", void 0);
NewRnrsTraspasoIndeterminadaComponent = __decorate([
    core_1.Component({
...
exports.NewRnrsTraspasoIndeterminadaComponent = NewRnrsTraspasoIndeterminadaComponent;
//# sourceMappingURL=newRnrs.traspasoIndeterminada.component.js.map