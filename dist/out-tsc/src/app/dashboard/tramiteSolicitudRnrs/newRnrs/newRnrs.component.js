...
var tramiteSolicitudRnrs_modelo_1 = require("../tramiteSolicitudRnrs.modelo");
...
var NewRnrsComponent = (function () {
    function NewRnrsComponent(_TramiteSolicitudService, _loginService, _tramiteFacturaService, _facturaService, _ciudadanoVehiculoService, _ciudadanoService) {
    ...
    NewRnrsComponent.prototype.ngOnInit = function () {
        ...
        this.tramiteSolicitud = new tramiteSolicitudRnrs_modelo_1.TramiteSolicitud(null, null, null, null, null, null, null, null);
    };
    NewRnrsComponent.prototype.onCancelar = function () {
        this.ready.emit(true);
    };
    NewRnrsComponent.prototype.onEnviar = function () {
        var _this = this;
    ...
    NewRnrsComponent.prototype.changedFactura = function (id) {
        var _this = this;
        if (id) {
    ...
    NewRnrsComponent.prototype.onKeyValidateVehiculo = function () {
        var _this = this;
        this.msj = '';
        this.mensaje = '';
        sweetalert2_1.default({
    ...
    NewRnrsComponent.prototype.readyTramite = function (datos) {
        var _this = this;
    ...
    NewRnrsComponent.prototype.cancelarTramite = function () {
        this.tramiteSelected = false;
        this.error = false;
    };
    NewRnrsComponent.prototype.finalizarSolicitud = function () {
        var _this = this;
        var token = this._loginService.getToken();
        this.tramites = '';
        this.tramitesFactura.forEach(function (tramiteFactura) {
    ...
    NewRnrsComponent.prototype.agregarApoderado = function () {
        this.frmApoderado = true;
    };
    NewRnrsComponent.prototype.btnNewApoderado = function () {
        this.frmApoderado = false;
        this.apoderado = this.apoderadoSelect;
        this.apoderadoEncontrado = 1;
    };
    NewRnrsComponent.prototype.onKeyApoderado = function () {
        var _this = this;
        var token = this._loginService.getToken();
        var identificacion = {
    ...
    NewRnrsComponent.prototype.cerrarApoderado = function () {
        this.frmApoderado = false;
        this.apoderado = false;
        this.apoderadoEncontrado = 1;
    };
    return NewRnrsComponent;
}());
__decorate([
    core_1.Output(),
    __metadata("design:type", Object)
], NewRnrsComponent.prototype, "ready", void 0);
NewRnrsComponent = __decorate([
    core_1.Component({
        selector: 'app-new',
...
exports.NewRnrsComponent = NewRnrsComponent;
//# sourceMappingURL=newRnrs.component.js.map