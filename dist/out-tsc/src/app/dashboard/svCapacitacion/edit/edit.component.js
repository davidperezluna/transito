...
var EditComponent = (function () {
    function EditComponent(_SvCapacitacionService, _loginService) {
        this._SvCapacitacionService = _SvCapacitacionService;
    ...
    EditComponent.prototype.onEnviar = function () {
        ...
        this._SvCapacitacionService.edit(this.capacitacion, token).subscribe(function (response) {
...
__decorate([
    core_1.Input(),
    __metadata("design:type", Object)
], EditComponent.prototype, "capacitacion", void 0);
