...
var EditComponent = (function () {
    function EditComponent(_evaluacionService, _loginService) {
        this._evaluacionService = _evaluacionService;
        this._loginService = _loginService;
        this.ready = new core_1.EventEmitter();
        this.msvEvaluacion = null;
    ...
    EditComponent.prototype.onEnviar = function () {
        ...
        this._evaluacionService.editEvaluacion(this.msvEvaluacion, token).subscribe(function (response) {
...
__decorate([
    core_1.Input(),
    __metadata("design:type", Object)
], EditComponent.prototype, "msvEvaluacion", void 0);
