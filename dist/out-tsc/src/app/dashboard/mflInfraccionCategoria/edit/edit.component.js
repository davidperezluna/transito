...
var EditComponent = (function () {
    function EditComponent(_InfraccionCategoriaService, _loginService) {
        this._InfraccionCategoriaService = _InfraccionCategoriaService;
        this._loginService = _loginService;
        this.ready = new core_1.EventEmitter();
        this.infraccionCategoria = null;
        this.formReady = false;
    }
    EditComponent.prototype.ngOnInit = function () { console.log(this.infraccionCategoria); };
    EditComponent.prototype.onCancelar = function () { this.ready.emit(true); };
    EditComponent.prototype.onEnviar = function () {
        var _this = this;
        var token = this._loginService.getToken();
        this._InfraccionCategoriaService.edit(this.infraccionCategoria, token).subscribe(function (response) {
...
__decorate([
    core_1.Input(),
    __metadata("design:type", Object)
], EditComponent.prototype, "infraccionCategoria", void 0);
