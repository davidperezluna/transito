...
var ExportComponent = (function () {
    function ExportComponent(_ComparendoService) {
    ...
    ExportComponent.prototype.ngOnInit = function () {
        ...
        this._ComparendoService.export().subscribe(function (response) {
    ...
    ExportComponent.prototype.iniciarTabla = function () {
    ...
    ExportComponent.prototype.ready = function (isCreado) {
        if (isCreado) {
            this.formNew = false;
            this.formEdit = false;
            this.formIndex = true;
