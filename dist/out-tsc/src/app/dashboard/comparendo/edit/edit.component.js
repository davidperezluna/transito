...
var EditComponent = /** @class */ (function () {
    function EditComponent(_comparendoService, _loginService, _bancoService) {
    ...
    EditComponent.prototype.ngOnInit = function () {
        ...
        this._bancoService.getBancoSelect().subscribe(function (response) {
            ...
            setTimeout(function () {
                _this.bancoSelected = [_this.comparendo.banco.id];
    ...
    EditComponent.prototype.onEnviar = function () {
        ...
        this._comparendoService.editComparendo(this.comparendo, token).subscribe(function (response) {
    ...
    __decorate([
        core_1.Input(),
        __metadata("design:type", Object)
    ], EditComponent.prototype, "comparendo", void 0);
