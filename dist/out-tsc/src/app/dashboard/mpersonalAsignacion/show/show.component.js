...
var ShowComponent = (function () {
    function ShowComponent(_AsignacionService, _ComparendoService, _loginService) {
        ...
        this.apiUrl = environment_1.environment.apiUrl + 'mpersonalasignacion';
    }
    ShowComponent.prototype.ngOnInit = function () {
        var _this = this;
        var token = this._loginService.getToken();
        this._ComparendoService.record(this.funcionario, token).subscribe(function (response) {
