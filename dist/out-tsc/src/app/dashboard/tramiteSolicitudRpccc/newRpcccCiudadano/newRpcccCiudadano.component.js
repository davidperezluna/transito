...
var NewRpcccCiudadanoComponent = (function () {
    function NewRpcccCiudadanoComponent(_CiudadanoService, _loginService, _tipoIdentificacionService, _generoService, _grupoSanguineoService, _municipioService) {
    ...
    NewRpcccCiudadanoComponent.prototype.ngOnInit = function () {
        var _this = this;
    ...
    NewRpcccCiudadanoComponent.prototype.onCancelar = function () {
        this.ready.emit(false);
    };
    NewRpcccCiudadanoComponent.prototype.onEnviar = function () {
        var _this = this;
    ...
    return NewRpcccCiudadanoComponent;
}());
__decorate([
    core_1.Output(),
    __metadata("design:type", Object)
], NewRpcccCiudadanoComponent.prototype, "ready", void 0);
__decorate([
    core_1.Input(),
    __metadata("design:type", Object)
], NewRpcccCiudadanoComponent.prototype, "identificacion", void 0);
__decorate([
    core_1.Input(),
    __metadata("design:type", Object)
], NewRpcccCiudadanoComponent.prototype, "tipoIdentificacion", void 0);
NewRpcccCiudadanoComponent = __decorate([
    core_1.Component({
        selector: 'app-new-rpccc-ciudadano',
        templateUrl: './newRpcccCiudadano.component.html'
    }),
...
exports.NewRpcccCiudadanoComponent = NewRpcccCiudadanoComponent;
//# sourceMappingURL=newRpcccCiudadano.component.js.map