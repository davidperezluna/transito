...
var TramiteSolicitudRpcccComponent = (function () {
    function TramiteSolicitudRpcccComponent(_TramiteSolicitudRpcccService, _TramiteSolicitudService, _TipoIdentificacionService, _CiudadanoService, _loginService) {
    ...
    TramiteSolicitudRpcccComponent.prototype.ngOnInit = function () {
        var _this = this;
    ...
    TramiteSolicitudRpcccComponent.prototype.iniciarTabla = function () {
    ...
    TramiteSolicitudRpcccComponent.prototype.onNew = function () {
        var _this = this;
    ...
    TramiteSolicitudRpcccComponent.prototype.ready = function (isCreado) {
        if (isCreado) {
            this.formNew = false;
            this.formEdit = false;
            this.formIndex = true;
    ...
    TramiteSolicitudRpcccComponent.prototype.onSearchSolicitante = function () {
        var _this = this;
    ...
    TramiteSolicitudRpcccComponent.prototype.deleteTramiteSolicitudRpccc = function (id) {
        var _this = this;
        sweetalert2_1.default({
            title: '¿Estás seguro?',
            ...
            if (result.value) {
                ...
                _this._TramiteSolicitudRpcccService.delete(token, id).subscribe(function (response) {
                    sweetalert2_1.default({
                        title: 'Eliminado!',
    ...
    TramiteSolicitudRpcccComponent.prototype.editTramiteSolicitudRpccc = function (tramiteSolicitud) {
        this.tramiteSolicitud = tramiteSolicitud;
        this.formEdit = true;
        this.formIndex = false;
    };
    return TramiteSolicitudRpcccComponent;
}());
TramiteSolicitudRpcccComponent = __decorate([
    core_1.Component({
        selector: 'app-index',
...
exports.TramiteSolicitudRpcccComponent = TramiteSolicitudRpcccComponent;
//# sourceMappingURL=tramiteSolicitudRpccc.component.js.map