...
var tramiteSolicitudRpccc_modelo_1 = require("../tramiteSolicitudRpccc.modelo");
...
var NewRpcccComponent = (function () {
    function NewRpcccComponent(_TramiteSolicitudRpcccService, _loginService, _TramiteFacturaService, _FacturaService, _ciudadanoVehiculoService, _ciudadanoService) {
        this._TramiteSolicitudRpcccService = _TramiteSolicitudRpcccService;
    ...
    NewRpcccComponent.prototype.ngOnInit = function () {
        this.tramiteSolicitud = new tramiteSolicitudRpccc_modelo_1.TramiteSolicitudRpccc(null, null, null, null, null, null, null);
    };
    NewRpcccComponent.prototype.onCancelar = function () {
        this.ready.emit(true);
    };
    NewRpcccComponent.prototype.onSearchFactura = function () {
        var _this = this;
    ...
    NewRpcccComponent.prototype.onEnviar = function () {
        var _this = this;
        var token = this._loginService.getToken();
        this.tramiteSolicitud.tramiteFacturaId = this.tramiteFacturaSelected;
        this._TramiteSolicitudRpcccService.register(this.tramiteSolicitud, token).subscribe(function (response) {
    ...
    NewRpcccComponent.prototype.readyTramite = function (datos) {
        var _this = this;
        console.log(datos);
    ...
    NewRpcccComponent.prototype.cancelarTramite = function () {
        this.tramiteSelected = false;
        this.error = false;
    };
    NewRpcccComponent.prototype.finalizarSolicitud = function () {
        var _this = this;
        var token = this._loginService.getToken();
        this.tramites = '';
        this.tramitesFactura.forEach(function (tramiteFactura) {
    ...
    return NewRpcccComponent;
}());
__decorate([
    core_1.Output(),
    __metadata("design:type", Object)
], NewRpcccComponent.prototype, "ready", void 0);
__decorate([
    core_1.Input(),
    __metadata("design:type", Object)
], NewRpcccComponent.prototype, "solicitante", void 0);
NewRpcccComponent = __decorate([
    core_1.Component({
        selector: 'app-new',
        templateUrl: './newRpccc.component.html'
    }),
    __metadata("design:paramtypes", [tramiteSolicitudRpccc_service_1.TramiteSolicitudRpcccService,
...
exports.NewRpcccComponent = NewRpcccComponent;
//# sourceMappingURL=newRpccc.component.js.map