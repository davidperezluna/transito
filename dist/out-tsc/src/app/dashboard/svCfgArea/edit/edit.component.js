...
var EditComponent = (function () {
    function EditComponent(_AreaService, _loginService, _TipoAreaService) {
    ...
    EditComponent.prototype.ngOnInit = function () {
        ...
        this._TipoAreaService.getTipoAreaSelect().subscribe(function (response) {
            ...
            setTimeout(function () {
                _this.tipoAreaSelected = [_this.area.tipoArea.id];
            });
        }, function (error) {
    ...
    EditComponent.prototype.onEnviar = function () {
        ...
        this._AreaService.edit(this.area, token).subscribe(function (response) {
...
__decorate([
    core_1.Input(),
    __metadata("design:type", Object)
], EditComponent.prototype, "area", void 0);
