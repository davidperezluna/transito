...
var EditComponent = (function () {
    function EditComponent(_CondicionViaService, _loginService) {
        this._CondicionViaService = _CondicionViaService;
        this._loginService = _loginService;
        this.ready = new core_1.EventEmitter();
        this.condicionVia = null;
    ...
    EditComponent.prototype.onEnviar = function () {
        ...
        this._CondicionViaService.edit(this.condicionVia, token).subscribe(function (response) {
...
__decorate([
    core_1.Input(),
    __metadata("design:type", Object)
], EditComponent.prototype, "condicionVia", void 0);
