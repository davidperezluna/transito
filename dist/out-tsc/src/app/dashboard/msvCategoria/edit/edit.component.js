...
var EditComponent = (function () {
    function EditComponent(_CategoriaService, _loginService) {
        this._CategoriaService = _CategoriaService;
        this._loginService = _loginService;
        this.ready = new core_1.EventEmitter();
        this.msvCategoria = null;
    ...
    EditComponent.prototype.onEnviar = function () {
        ...
        this._CategoriaService.editCategoria(this.msvCategoria, token).subscribe(function (response) {
...
__decorate([
    core_1.Input(),
    __metadata("design:type", Object)
], EditComponent.prototype, "msvCategoria", void 0);
