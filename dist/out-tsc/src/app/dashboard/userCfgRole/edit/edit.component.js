...
var EditComponent = (function () {
    function EditComponent(_UserCfgRoleService, _UserCfgMenuService, _loginService) {
    ...
    EditComponent.prototype.ngOnInit = function () {
        ...
        this._UserCfgMenuService.list().subscribe(function (response) {
    ...
    EditComponent.prototype.onChanged = function (id, isChecked) {
        if (isChecked) {
            this.menuArray.push(id);
        }
        else {
            var index = this.menuArray.indexOf(id);
    ...
    EditComponent.prototype.onEnviar = function () {
        ...
        this._UserCfgRoleService.edit(this.role, token).subscribe(function (response) {
...
__decorate([
    core_1.Input(),
    __metadata("design:type", Object)
], EditComponent.prototype, "role", void 0);
EditComponent = __decorate([
    ...
    __metadata("design:paramtypes", [userCfgRole_service_1.UserCfgRoleService,
        userCfgMenu_service_1.UserCfgMenuService,
