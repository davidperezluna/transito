...
var userCfgRole_modelo_1 = require("../userCfgRole.modelo");
var userCfgRole_service_1 = require("../../../services/userCfgRole.service");
var login_service_1 = require("../../../services/login.service");
var sweetalert2_1 = require("sweetalert2");
var NewComponent = (function () {
    function NewComponent(_UserCfgRoleService, _loginService) {
        this._UserCfgRoleService = _UserCfgRoleService;
        this._loginService = _loginService;
        this.ready = new core_1.EventEmitter();
    }
    NewComponent.prototype.ngOnInit = function () {
        this.role = new userCfgRole_modelo_1.UserCfgRole(null, null);
    };
    ...
    NewComponent.prototype.onEnviar = function () {
        ...
        this._UserCfgRoleService.register(this.role, token).subscribe(function (response) {
