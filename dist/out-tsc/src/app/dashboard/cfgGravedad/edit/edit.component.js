...
var EditComponent = (function () {
    function EditComponent(_CfgGravedadService, _loginService) {
        this._CfgGravedadService = _CfgGravedadService;
        this._loginService = _loginService;
        this.ready = new core_1.EventEmitter();
        this.cfgGravedad = null;
    }
    ...
    EditComponent.prototype.onEnviar = function () {
        ...
        this._CfgGravedadService.editCfgGravedad(this.cfgGravedad, token).subscribe(function (response) {
...
__decorate([
    core_1.Input(),
    __metadata("design:type", Object)
], EditComponent.prototype, "cfgGravedad", void 0);
