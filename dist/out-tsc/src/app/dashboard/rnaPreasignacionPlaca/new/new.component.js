...
var rnaPreasignacionPlaca_modelo_1 = require("../rnaPreasignacionPlaca.modelo");
...
var NewComponent = (function () {
    ...
    NewComponent.prototype.ngOnInit = function () {
        this.color = new rnaPreasignacionPlaca_modelo_1.Color(null, null);
    };
    ...
    NewComponent.prototype.onEnviar = function () {
        ...
        this._ColorService.register(this.color, token).subscribe(function (response) {
            ...
            if (_this.respuesta.status == 'success') {
                ...
                sweetalert2_1.default({
                    title: 'Error!',
                    text: 'El color ' + _this.color.nombre + ' ya se encuentra registrado',
                    type: 'error',
                    confirmButtonText: 'Aceptar'
                });
            }
