...
var TramiteComponent = (function () {
    function TramiteComponent(_TramiteService, _loginService) {
    ...
    TramiteComponent.prototype.onNew = function () {
        this.formNew = true;
        this.formIndex = false;
        this.table.destroy();
    };
    TramiteComponent.prototype.ready = function (isCreado) {
        if (isCreado) {
            this.formNew = false;
            this.formEdit = false;
            this.formIndex = true;
    ...
    TramiteComponent.prototype.deleteTramite = function (id) {
        var _this = this;
        sweetalert2_1.default({
            title: '¿Estás seguro?',
            ...
            if (result.value) {
                ...
                _this._TramiteService.deleteTramite(token, id).subscribe(function (response) {
                    sweetalert2_1.default({
                        title: 'Eliminado!',
    ...
    TramiteComponent.prototype.editTramite = function (tramite) {
