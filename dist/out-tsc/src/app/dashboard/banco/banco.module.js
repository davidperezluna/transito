...
var BancoModule = /** @class */ (function () {
    function BancoModule() {
    }
    BancoModule = __decorate([
        core_1.NgModule({
            imports: [common_1.CommonModule, ng2_bootstrap_1.Ng2BootstrapModule.forRoot()],
            declarations: [banco_component_1.BancoComponent, new_component_1.NewComponent, edit_component_1.EditComponent],
            exports: [banco_component_1.BancoComponent, new_component_1.NewComponent, edit_component_1.EditComponent],
