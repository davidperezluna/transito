...
var BancoComponent = (function () {
    function BancoComponent(_BancoService, _loginService) {
    ...
    BancoComponent.prototype.iniciarTabla = function () {
    ...
    BancoComponent.prototype.onNew = function () {
        this.formNew = true;
        this.formIndex = false;
        this.table.destroy();
    };
    BancoComponent.prototype.ready = function (isCreado) {
        if (isCreado) {
            this.formNew = false;
            this.formEdit = false;
            this.formIndex = true;
    ...
    BancoComponent.prototype.deleteBanco = function (id) {
        var _this = this;
        sweetalert2_1.default({
            title: '¿Estás seguro?',
            ...
            if (result.value) {
                ...
                _this._BancoService.deleteBanco(token, id).subscribe(function (response) {
                    sweetalert2_1.default({
                        title: 'Eliminado!',
    ...
    BancoComponent.prototype.editBanco = function (banco) {
        this.banco = banco;
        this.formEdit = true;
        this.formIndex = false;
    };
