...
var banco_modelo_1 = require("../banco.modelo");
var banco_service_1 = require("../../../services/banco.service");
var login_service_1 = require("../../../services/login.service");
var sweetalert2_1 = require("sweetalert2");
var NewComponent = /** @class */ (function () {
    function NewComponent(_BancoService, _loginService) {
        this._BancoService = _BancoService;
        this._loginService = _loginService;
        this.ready = new core_1.EventEmitter();
    }
    NewComponent.prototype.ngOnInit = function () {
        this.banco = new banco_modelo_1.Banco(null, null);
    };
    ...
    NewComponent.prototype.onEnviar = function () {
        ...
        this._BancoService.register(this.banco, token).subscribe(function (response) {
            ...
            if (_this.respuesta.status == 'success') {
                ...
                sweetalert2_1.default({
                    title: 'Error!',
                    text: 'El banco ' + _this.banco.nombre + ' ya se encuentra registrado',
                    type: 'error',
                    confirmButtonText: 'Aceptar'
                });
            }
