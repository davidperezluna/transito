...
var vhloCfgCondicionIngreso_modelo_1 = require("../vhloCfgCondicionIngreso.modelo");
var vhloCfgCondicionIngreso_service_1 = require("../../../services/vhloCfgCondicionIngreso.service");
var login_service_1 = require("../../../services/login.service");
var sweetalert2_1 = require("sweetalert2");
var NewComponent = (function () {
    function NewComponent(_CondicionIngresoService, _loginService) {
        this._CondicionIngresoService = _CondicionIngresoService;
        this._loginService = _loginService;
        this.ready = new core_1.EventEmitter();
    }
    NewComponent.prototype.ngOnInit = function () {
        this.condicionIngreso = new vhloCfgCondicionIngreso_modelo_1.VhloCfgCondicionIngreso(null, null);
    };
    ...
    NewComponent.prototype.onEnviar = function () {
        ...
        this._CondicionIngresoService.register(this.condicionIngreso, token).subscribe(function (response) {
