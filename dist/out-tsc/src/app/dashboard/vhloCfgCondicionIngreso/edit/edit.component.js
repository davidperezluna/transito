...
var EditComponent = (function () {
    function EditComponent(_CondicionIngresoService, _loginService) {
        this._CondicionIngresoService = _CondicionIngresoService;
        this._loginService = _loginService;
        this.ready = new core_1.EventEmitter();
        this.condicionIngreso = null;
    ...
    EditComponent.prototype.onEnviar = function () {
        ...
        this._CondicionIngresoService.edit(this.condicionIngreso, token).subscribe(function (response) {
...
__decorate([
    core_1.Input(),
    __metadata("design:type", Object)
], EditComponent.prototype, "condicionIngreso", void 0);
