...
var EditComponent = (function () {
    function EditComponent(_SustanciaPeligrosaService, _loginService) {
        this._SustanciaPeligrosaService = _SustanciaPeligrosaService;
        this._loginService = _loginService;
        this.ready = new core_1.EventEmitter();
        this.sustanciaPeligrosa = null;
    ...
    EditComponent.prototype.onEnviar = function () {
        ...
        this._SustanciaPeligrosaService.edit(this.sustanciaPeligrosa, token).subscribe(function (response) {
...
__decorate([
    core_1.Input(),
    __metadata("design:type", Object)
], EditComponent.prototype, "sustanciaPeligrosa", void 0);
