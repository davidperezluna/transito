...
var svCfgSustanciaPeligrosa_modelo_1 = require("../svCfgSustanciaPeligrosa.modelo");
var svCfgSustanciaPeligrosa_service_1 = require("../../../services/svCfgSustanciaPeligrosa.service");
var login_service_1 = require("../../../services/login.service");
var sweetalert2_1 = require("sweetalert2");
var NewComponent = (function () {
    function NewComponent(_SustanciaPeligrosaService, _loginService) {
        this._SustanciaPeligrosaService = _SustanciaPeligrosaService;
        this._loginService = _loginService;
        this.ready = new core_1.EventEmitter();
    }
    NewComponent.prototype.ngOnInit = function () {
        this.sustanciaPeligrosa = new svCfgSustanciaPeligrosa_modelo_1.SvCfgSustanciaPeligrosa(null, null);
    };
    ...
    NewComponent.prototype.onEnviar = function () {
        ...
        this._SustanciaPeligrosaService.register(this.sustanciaPeligrosa, token).subscribe(function (response) {
