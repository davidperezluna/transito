...
var consumible_modelo_1 = require("../consumible.modelo");
var consumible_service_1 = require("../../../services/consumible.service");
var login_service_1 = require("../../../services/login.service");
var sweetalert2_1 = require("sweetalert2");
var NewComponent = (function () {
    function NewComponent(_ConsumibleService, _loginService) {
        this._ConsumibleService = _ConsumibleService;
        this._loginService = _loginService;
        this.ready = new core_1.EventEmitter();
    }
    NewComponent.prototype.ngOnInit = function () {
        this.consumible = new consumible_modelo_1.Consumible(null, null);
    };
    ...
    NewComponent.prototype.onEnviar = function () {
        ...
        this._ConsumibleService.register(this.consumible, token).subscribe(function (response) {
            ...
            if (_this.respuesta.status == 'success') {
                ...
                sweetalert2_1.default({
                    title: 'Error!',
                    text: 'El consumible ' + _this.consumible.nombre + ' ya se encuentra registrado',
                    type: 'error',
                    confirmButtonText: 'Aceptar'
                });
            }
