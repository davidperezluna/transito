...
var EditComponent = (function () {
    function EditComponent(_TipoViaService, _loginService, _TipoAreaService) {
    ...
    EditComponent.prototype.ngOnInit = function () {
        ...
        this._TipoAreaService.getTipoAreaSelect().subscribe(function (response) {
            ...
            setTimeout(function () {
                _this.tipoAreaSelected = [_this.tipoVia.tipoArea.id];
            });
        }, function (error) {
    ...
    EditComponent.prototype.onEnviar = function () {
        ...
        this._TipoViaService.edit(this.tipoVia, token).subscribe(function (response) {
...
__decorate([
    core_1.Input(),
    __metadata("design:type", Object)
], EditComponent.prototype, "tipoVia", void 0);
