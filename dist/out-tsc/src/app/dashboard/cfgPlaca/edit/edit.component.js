...
var EditComponent = (function () {
    ...
    function EditComponent(_CfgPlacaService, _loginService, _claseService, _sedeOperativaService) {
    ...
    EditComponent.prototype.ngOnInit = function () {
        ...
        this._claseService.getClaseSelect().subscribe(function (response) {
            ...
            setTimeout(function () {
                _this.claseSelected = [_this.cfgPlaca.clase.id];
            });
        }, function (error) {
        ...
        this._sedeOperativaService.getSedeOperativaSelect().subscribe(function (response) {
            ...
            setTimeout(function () {
                _this.sedeOperativaSelected = [_this.cfgPlaca.sedeOperativa.id];
            });
        }, function (error) {
            _this.errorMessage = error;
            if (_this.errorMessage != null) {
    ...
    EditComponent.prototype.onEnviar = function () {
        ...
        this._CfgPlacaService.editCfgPlaca(this.cfgPlaca, token).subscribe(function (response) {
