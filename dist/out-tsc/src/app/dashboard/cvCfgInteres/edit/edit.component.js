...
var EditComponent = (function () {
    function EditComponent(_InteresService, _loginService) {
    ...
    EditComponent.prototype.ngOnInit = function () { console.log(this.interes); };
    EditComponent.prototype.onCancelar = function () { this.ready.emit(true); };
    EditComponent.prototype.onEnviar = function () {
        var _this = this;
        var token = this._loginService.getToken();
        this._InteresService.edit(this.interes, token).subscribe(function (response) {
...
__decorate([
    core_1.Input(),
    __metadata("design:type", Object)
], EditComponent.prototype, "interes", void 0);
