...
var EditComponent = (function () {
    function EditComponent(_TipoControlService, _loginService) {
    ...
    EditComponent.prototype.onEnviar = function () {
        ...
        this._TipoControlService.edit(this.tipoControl, token).subscribe(function (response) {
...
__decorate([
    core_1.Input(),
    __metadata("design:type", Object)
], EditComponent.prototype, "tipoControl", void 0);
