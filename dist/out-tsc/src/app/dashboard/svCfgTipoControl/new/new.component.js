...
var svCfgTipoControl_modelo_1 = require("../svCfgTipoControl.modelo");
var svCfgTipoControl_service_1 = require("../../../services/svCfgTipoControl.service");
var login_service_1 = require("../../../services/login.service");
var sweetalert2_1 = require("sweetalert2");
var NewComponent = (function () {
    function NewComponent(_TipoControlService, _loginService) {
        this._TipoControlService = _TipoControlService;
        this._loginService = _loginService;
        this.ready = new core_1.EventEmitter();
    }
    NewComponent.prototype.ngOnInit = function () {
        this.tipoControl = new svCfgTipoControl_modelo_1.SvCfgTipoControl(null, null);
    };
    ...
    NewComponent.prototype.onEnviar = function () {
        ...
        this._TipoControlService.register(this.tipoControl, token).subscribe(function (response) {
