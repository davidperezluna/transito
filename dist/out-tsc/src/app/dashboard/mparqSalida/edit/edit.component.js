...
var EditComponent = (function () {
    function EditComponent(_EntradaService, _loginService) {
    ...
    EditComponent.prototype.ngOnInit = function () { console.log(this.entrada); };
    EditComponent.prototype.onCancelar = function () { this.ready.emit(true); };
    EditComponent.prototype.onEnviar = function () {
        var _this = this;
        var token = this._loginService.getToken();
        this._EntradaService.edit(this.entrada, token).subscribe(function (response) {
...
__decorate([
    core_1.Input(),
    __metadata("design:type", Object)
], EditComponent.prototype, "entrada", void 0);
