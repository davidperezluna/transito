...
var vhloCfgSubpartidaArancelaria_modelo_1 = require("../vhloCfgSubpartidaArancelaria.modelo");
var vhloCfgSubpartidaArancelaria_service_1 = require("../../../services/vhloCfgSubpartidaArancelaria.service");
var login_service_1 = require("../../../services/login.service");
var sweetalert2_1 = require("sweetalert2");
var NewComponent = (function () {
    function NewComponent(_SubpartidaArancelariaService, _loginService) {
        this._SubpartidaArancelariaService = _SubpartidaArancelariaService;
        this._loginService = _loginService;
        this.ready = new core_1.EventEmitter();
    }
    NewComponent.prototype.ngOnInit = function () {
        this.subpartidaArancelaria = new vhloCfgSubpartidaArancelaria_modelo_1.VhloCfgSubpartidaArancelaria(null, null);
    };
    ...
    NewComponent.prototype.onEnviar = function () {
        ...
        this._SubpartidaArancelariaService.register(this.subpartidaArancelaria, token).subscribe(function (response) {
