...
var EditComponent = (function () {
    function EditComponent(_SubpartidaArancelariaService, _loginService) {
        this._SubpartidaArancelariaService = _SubpartidaArancelariaService;
        this._loginService = _loginService;
        this.ready = new core_1.EventEmitter();
        this.subpartidaArancelaria = null;
    ...
    EditComponent.prototype.onEnviar = function () {
        ...
        this._SubpartidaArancelariaService.edit(this.subpartidaArancelaria, token).subscribe(function (response) {
...
__decorate([
    core_1.Input(),
    __metadata("design:type", Object)
], EditComponent.prototype, "subpartidaArancelaria", void 0);
