...
var EditComponent = (function () {
    function EditComponent(_CfgClaseAccidenteService, _loginService) {
        this._CfgClaseAccidenteService = _CfgClaseAccidenteService;
        this._loginService = _loginService;
        this.ready = new core_1.EventEmitter();
        this.cfgClaseAccidente = null;
    }
    ...
    EditComponent.prototype.onEnviar = function () {
        ...
        this._CfgClaseAccidenteService.editCfgClaseAccidente(this.cfgClaseAccidente, token).subscribe(function (response) {
...
__decorate([
    core_1.Input(),
    __metadata("design:type", Object)
], EditComponent.prototype, "cfgClaseAccidente", void 0);
