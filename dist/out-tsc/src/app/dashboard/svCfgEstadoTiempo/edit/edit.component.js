...
var EditComponent = (function () {
    function EditComponent(_EstadoTiempoService, _loginService) {
        this._EstadoTiempoService = _EstadoTiempoService;
        this._loginService = _loginService;
        this.ready = new core_1.EventEmitter();
        this.estadoTiempo = null;
    ...
    EditComponent.prototype.onEnviar = function () {
        ...
        this._EstadoTiempoService.edit(this.estadoTiempo, token).subscribe(function (response) {
...
__decorate([
    core_1.Input(),
    __metadata("design:type", Object)
], EditComponent.prototype, "estadoTiempo", void 0);
