...
var svCfgEstadoTiempo_modelo_1 = require("../svCfgEstadoTiempo.modelo");
var svCfgEstadoTiempo_service_1 = require("../../../services/svCfgEstadoTiempo.service");
var login_service_1 = require("../../../services/login.service");
var sweetalert2_1 = require("sweetalert2");
var NewComponent = (function () {
    function NewComponent(_EstadoTiempoService, _loginService) {
        this._EstadoTiempoService = _EstadoTiempoService;
        this._loginService = _loginService;
        this.ready = new core_1.EventEmitter();
    }
    NewComponent.prototype.ngOnInit = function () {
        this.estadoTiempo = new svCfgEstadoTiempo_modelo_1.SvCfgEstadoTiempo(null, null);
    };
    ...
    NewComponent.prototype.onEnviar = function () {
        ...
        this._EstadoTiempoService.register(this.estadoTiempo, token).subscribe(function (response) {
