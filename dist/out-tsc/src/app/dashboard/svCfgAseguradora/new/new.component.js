...
var svCfgAseguradora_modelo_1 = require("../svCfgAseguradora.modelo");
var svCfgAseguradora_service_1 = require("../../../services/svCfgAseguradora.service");
var login_service_1 = require("../../../services/login.service");
var sweetalert2_1 = require("sweetalert2");
var NewComponent = (function () {
    function NewComponent(_AseguradoraService, _loginService) {
        this._AseguradoraService = _AseguradoraService;
        this._loginService = _loginService;
        this.ready = new core_1.EventEmitter();
    }
    NewComponent.prototype.ngOnInit = function () {
        this.aseguradora = new svCfgAseguradora_modelo_1.SvCfgAseguradora(null, null);
    };
    ...
    NewComponent.prototype.onEnviar = function () {
        ...
        this._AseguradoraService.register(this.aseguradora, token).subscribe(function (response) {
