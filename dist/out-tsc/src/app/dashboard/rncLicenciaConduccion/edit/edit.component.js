...
var EditComponent = (function () {
    function EditComponent(_LicenciaService, _loginService) {
        this._LicenciaService = _LicenciaService;
        this._loginService = _loginService;
        this.ready = new core_1.EventEmitter();
        this.licencia = null;
        this.formReady = false;
    }
    EditComponent.prototype.ngOnInit = function () { console.log(this.licencia); };
    EditComponent.prototype.onCancelar = function () { this.ready.emit(true); };
    EditComponent.prototype.onEnviar = function () {
        var _this = this;
        var token = this._loginService.getToken();
        this._LicenciaService.edit(this.licencia, token).subscribe(function (response) {
...
__decorate([
    core_1.Input(),
    __metadata("design:type", Object)
], EditComponent.prototype, "licencia", void 0);
