...
var servicio_modelo_1 = require("../servicio.modelo");
var servicio_service_1 = require("../../../services/servicio.service");
var login_service_1 = require("../../../services/login.service");
var sweetalert2_1 = require("sweetalert2");
var NewComponent = /** @class */ (function () {
    function NewComponent(_ServicioService, _loginService) {
        this._ServicioService = _ServicioService;
        this._loginService = _loginService;
        this.ready = new core_1.EventEmitter();
    }
    NewComponent.prototype.ngOnInit = function () {
        this.servicio = new servicio_modelo_1.Servicio(null, null, null);
    };
    ...
    NewComponent.prototype.onEnviar = function () {
        ...
        this._ServicioService.register(this.servicio, token).subscribe(function (response) {
            ...
            if (_this.respuesta.status == 'success') {
                ...
                sweetalert2_1.default({
                    title: 'Error!',
                    text: 'El servicio ' + _this.servicio.nombre + ' ya se encuentra registrado',
                    type: 'error',
                    confirmButtonText: 'Aceptar'
                });
            }
