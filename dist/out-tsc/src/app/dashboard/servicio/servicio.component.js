...
var ServicioComponent = (function () {
    function ServicioComponent(_ServicioService, _loginService) {
    ...
    ServicioComponent.prototype.iniciarTabla = function () {
    ...
    ServicioComponent.prototype.onNew = function () {
        this.formNew = true;
        this.formIndex = false;
        this.table.destroy();
    };
    ServicioComponent.prototype.ready = function (isCreado) {
        if (isCreado) {
            this.formNew = false;
            this.formEdit = false;
            this.formIndex = true;
    ...
    ServicioComponent.prototype.deleteServicio = function (id) {
        var _this = this;
        sweetalert2_1.default({
            title: '¿Estás seguro?',
            ...
            if (result.value) {
                ...
                _this._ServicioService.deleteServicio(token, id).subscribe(function (response) {
                    sweetalert2_1.default({
                        title: 'Eliminado!',
    ...
    ServicioComponent.prototype.editServicio = function (servicio) {
