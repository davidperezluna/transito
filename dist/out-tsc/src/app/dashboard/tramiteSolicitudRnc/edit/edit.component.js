...
var EditComponent = (function () {
    function EditComponent(_tramiteSolicitudRncService, _loginService, _tramiteFacturaService) {
    ...
    EditComponent.prototype.onEnviar = function () {
        ...
        this._tramiteSolicitudRncService.edit(this.tramiteSolicitud, token).subscribe(function (response) {
