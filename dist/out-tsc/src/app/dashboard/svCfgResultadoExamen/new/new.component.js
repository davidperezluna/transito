...
var svCfgResultadoExamen_modelo_1 = require("../svCfgResultadoExamen.modelo");
var svCfgResultadoExamen_service_1 = require("../../../services/svCfgResultadoExamen.service");
var login_service_1 = require("../../../services/login.service");
var sweetalert2_1 = require("sweetalert2");
var NewComponent = (function () {
    function NewComponent(_ResultadoExamenService, _loginService) {
        this._ResultadoExamenService = _ResultadoExamenService;
        this._loginService = _loginService;
        this.ready = new core_1.EventEmitter();
    }
    NewComponent.prototype.ngOnInit = function () {
        this.resultadoExamen = new svCfgResultadoExamen_modelo_1.SvCfgResultadoExamen(null, null);
    };
    ...
    NewComponent.prototype.onEnviar = function () {
        ...
        this._ResultadoExamenService.register(this.resultadoExamen, token).subscribe(function (response) {
