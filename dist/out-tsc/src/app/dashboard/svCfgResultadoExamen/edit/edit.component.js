...
var EditComponent = (function () {
    function EditComponent(_ResultadoExamenService, _loginService) {
    ...
    EditComponent.prototype.onEnviar = function () {
        ...
        this._ResultadoExamenService.edit(this.resultadoExamen, token).subscribe(function (response) {
...
__decorate([
    core_1.Input(),
    __metadata("design:type", Object)
], EditComponent.prototype, "resultadoExamen", void 0);
