...
var EditComponent = (function () {
    ...
    EditComponent.prototype.ngOnInit = function () {
        ...
        this._ClaseAccidenteService.getClaseAccidenteSelect().subscribe(function (response) {
            ...
            setTimeout(function () {
                _this.claseAccidenteSelected = [_this.claseChoque.claseAccidente.id];
            });
        }, function (error) {
    ...
    EditComponent.prototype.onEnviar = function () {
        ...
        this._ClaseChoqueService.edit(this.claseChoque, token).subscribe(function (response) {
...
__decorate([
    core_1.Input(),
    __metadata("design:type", Object)
], EditComponent.prototype, "claseChoque", void 0);
