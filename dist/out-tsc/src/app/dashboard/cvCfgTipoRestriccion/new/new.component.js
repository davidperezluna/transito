...
var cvCfgTipoRestriccion_modelo_1 = require("../cvCfgTipoRestriccion.modelo");
...
var NewComponent = (function () {
    function NewComponent(_AcuerdoPagoService, _InteresService, _loginService, _CvCfgTipoRestriccionService) {
    ...
    NewComponent.prototype.ngOnInit = function () {
        this.tipoRestriccion = new cvCfgTipoRestriccion_modelo_1.CvCfgTipoRestriccion(null, null);
    };
    ...
    NewComponent.prototype.onEnviar = function () {
        ...
        this._CvCfgTipoRestriccionService.register(this.tipoRestriccion, token).subscribe(function (response) {
