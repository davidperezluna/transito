...
var EditComponent = (function () {
    function EditComponent(_funcionarioService, _loginService) {
    ...
    EditComponent.prototype.ngOnInit = function () { console.log(this.funcionario); };
    EditComponent.prototype.onCancelar = function () { this.ready.emit(true); };
    EditComponent.prototype.onEnviar = function () {
        var _this = this;
        var token = this._loginService.getToken();
        this._funcionarioService.edit(this.funcionario, token).subscribe(function (response) {
...
__decorate([
    core_1.Input(),
    __metadata("design:type", Object)
], EditComponent.prototype, "funcionario", void 0);
