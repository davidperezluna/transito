...
var svCfgIluminacion_modelo_1 = require("../svCfgIluminacion.modelo");
var svCfgIluminacion_service_1 = require("../../../services/svCfgIluminacion.service");
var login_service_1 = require("../../../services/login.service");
var sweetalert2_1 = require("sweetalert2");
var NewComponent = (function () {
    function NewComponent(_IluminacionService, _loginService) {
        this._IluminacionService = _IluminacionService;
        this._loginService = _loginService;
        this.ready = new core_1.EventEmitter();
    }
    NewComponent.prototype.ngOnInit = function () {
        this.iluminacion = new svCfgIluminacion_modelo_1.SvCfgIluminacion(null, null);
    };
    ...
    NewComponent.prototype.onEnviar = function () {
        ...
        this._IluminacionService.register(this.iluminacion, token).subscribe(function (response) {
