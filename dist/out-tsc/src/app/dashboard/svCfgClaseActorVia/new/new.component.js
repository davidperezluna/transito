...
var NewComponent = (function () {
    function NewComponent(_ClaseActorViaService, _loginService) {
        this._ClaseActorViaService = _ClaseActorViaService;
        this._loginService = _loginService;
        this.ready = new core_1.EventEmitter();
        this.vehiculo = null;
    }
    NewComponent.prototype.ngOnInit = function () {
        this.claseActorVia = new svCfgClaseActorVia_modelo_1.SvCfgClaseActorVia(null, null);
    };
    ...
    NewComponent.prototype.onEnviar = function () {
        ...
        this._ClaseActorViaService.register(this.claseActorVia, token).subscribe(function (response) {
