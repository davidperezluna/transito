...
var EditComponent = (function () {
    function EditComponent(_ClaseActorViaService, _loginService) {
        this._ClaseActorViaService = _ClaseActorViaService;
        this._loginService = _loginService;
        this.ready = new core_1.EventEmitter();
        this.claseActorVial = null;
    ...
    EditComponent.prototype.onEnviar = function () {
        ...
        this._ClaseActorViaService.edit(this.claseActorVial, token).subscribe(function (response) {
...
__decorate([
    core_1.Input(),
    __metadata("design:type", Object)
], EditComponent.prototype, "claseActorVial", void 0);
