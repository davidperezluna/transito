...
var NewRnmaRegrabarVinComponent = (function () {
    function NewRnmaRegrabarVinComponent(_TramiteSolicitudService, _loginService, _SustratoService, _VehiculoService) {
    ...
    NewRnmaRegrabarVinComponent.prototype.ngOnInit = function () {
        var _this = this;
    ...
    NewRnmaRegrabarVinComponent.prototype.ready = function (e) {
    };
    NewRnmaRegrabarVinComponent.prototype.enviarTramite = function () {
        var _this = this;
        ...
        this._VehiculoService.editVehiculo(this.vehiculo, token).subscribe(function (response) {
            ...
            if (_this.respuesta.status == 'success') {
                ...
                _this.datos.tramiteFormulario = 'rnma-regrabarvin';
    ...
    NewRnmaRegrabarVinComponent.prototype.onCancelar = function () {
        this.cancelarTramite.emit(true);
    };
    return NewRnmaRegrabarVinComponent;
}());
__decorate([
    core_1.Output(),
    __metadata("design:type", Object)
], NewRnmaRegrabarVinComponent.prototype, "readyTramite", void 0);
__decorate([
    core_1.Output(),
    __metadata("design:type", Object)
], NewRnmaRegrabarVinComponent.prototype, "cancelarTramite", void 0);
__decorate([
    core_1.Input(),
    __metadata("design:type", Object)
], NewRnmaRegrabarVinComponent.prototype, "vehiculo", void 0);
__decorate([
    core_1.Input(),
    __metadata("design:type", Object)
], NewRnmaRegrabarVinComponent.prototype, "factura", void 0);
NewRnmaRegrabarVinComponent = __decorate([
    core_1.Component({
...
exports.NewRnmaRegrabarVinComponent = NewRnmaRegrabarVinComponent;
//# sourceMappingURL=newRnma.regrabarVin.component.js.map