...
var NewRnmaCambioCombustibleComponent = (function () {
    function NewRnmaCambioCombustibleComponent(_CombustibleService, _TramiteSolicitudService, _loginService, _VehiculoService) {
    ...
    NewRnmaCambioCombustibleComponent.prototype.ngOnInit = function () {
        var _this = this;
    ...
    NewRnmaCambioCombustibleComponent.prototype.enviarTramite = function () {
        var _this = this;
        ...
        this._CombustibleService.showCombustible(token, this.combustibleSelected).subscribe(function (combustible) {
            ...
            _this._VehiculoService.editVehiculo(_this.vehiculo, token).subscribe(function (response) {
                ...
                if (_this.respuesta.status == 'success') {
                    ...
                    _this.datos.tramiteFormulario = 'rnma-cambiocombustible';
    ...
    NewRnmaCambioCombustibleComponent.prototype.onCancelar = function () {
        this.cancelarTramite.emit(true);
    };
    return NewRnmaCambioCombustibleComponent;
}());
__decorate([
    core_1.Output(),
    __metadata("design:type", Object)
], NewRnmaCambioCombustibleComponent.prototype, "readyTramite", void 0);
__decorate([
    core_1.Output(),
    __metadata("design:type", Object)
], NewRnmaCambioCombustibleComponent.prototype, "cancelarTramite", void 0);
__decorate([
    core_1.Input(),
    __metadata("design:type", Object)
], NewRnmaCambioCombustibleComponent.prototype, "vehiculo", void 0);
__decorate([
    core_1.Input(),
    __metadata("design:type", Object)
], NewRnmaCambioCombustibleComponent.prototype, "factura", void 0);
NewRnmaCambioCombustibleComponent = __decorate([
    core_1.Component({
        selector: 'appRnma-cambio-combustible',
        templateUrl: './newRnma.cambioCombustible.html'
    }),
...
exports.NewRnmaCambioCombustibleComponent = NewRnmaCambioCombustibleComponent;
//# sourceMappingURL=newRnma.cambioCombustible.component.js.map