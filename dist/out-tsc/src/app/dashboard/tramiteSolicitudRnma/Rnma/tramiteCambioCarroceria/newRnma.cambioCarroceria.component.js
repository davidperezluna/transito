...
var NewRnmaCambioCarroceriaComponent = (function () {
    function NewRnmaCambioCarroceriaComponent(_CarroceriaService, _TramiteSolicitudService, _loginService, _VehiculoService) {
    ...
    NewRnmaCambioCarroceriaComponent.prototype.ngOnInit = function () {
        var _this = this;
    ...
    NewRnmaCambioCarroceriaComponent.prototype.enviarTramite = function () {
        var _this = this;
        ...
        this._CarroceriaService.showCarroceria(token, this.carroceriaSelected).subscribe(function (carroceria) {
            ...
            _this._VehiculoService.editVehiculo(_this.vehiculo, token).subscribe(function (response) {
                ...
                if (_this.respuesta.status == 'success') {
                    ...
                    _this.datos.tramiteFormulario = 'rnma-cambiocarroceria';
    ...
    NewRnmaCambioCarroceriaComponent.prototype.onCancelar = function () {
        this.cancelarTramite.emit(true);
    };
    return NewRnmaCambioCarroceriaComponent;
}());
__decorate([
    core_1.Output(),
    __metadata("design:type", Object)
], NewRnmaCambioCarroceriaComponent.prototype, "readyTramite", void 0);
__decorate([
    core_1.Output(),
    __metadata("design:type", Object)
], NewRnmaCambioCarroceriaComponent.prototype, "cancelarTramite", void 0);
__decorate([
    core_1.Input(),
    __metadata("design:type", Object)
], NewRnmaCambioCarroceriaComponent.prototype, "vehiculo", void 0);
__decorate([
    core_1.Input(),
    __metadata("design:type", Object)
], NewRnmaCambioCarroceriaComponent.prototype, "factura", void 0);
NewRnmaCambioCarroceriaComponent = __decorate([
    core_1.Component({
...
exports.NewRnmaCambioCarroceriaComponent = NewRnmaCambioCarroceriaComponent;
//# sourceMappingURL=newRnma.cambioCarroceria.component.js.map