...
var NewRnmaTramiteLevantamientoAlertaPrendaComponent = (function () {
    function NewRnmaTramiteLevantamientoAlertaPrendaComponent(_CfgTipoAlertaService, _TramiteSolicitudService, _BancoService, _loginService, _tramiteFacturaService, _VehiculoService, _VehiculoAcreedorService, _tipoIdentificacionService, _CiudadanoService, router, _EmpresaService) {
    ...
    ;
    NewRnmaTramiteLevantamientoAlertaPrendaComponent.prototype.ngOnInit = function () {
        var _this = this;
    ...
    NewRnmaTramiteLevantamientoAlertaPrendaComponent.prototype.enviarTramite = function () {
        var _this = this;
    ...
    NewRnmaTramiteLevantamientoAlertaPrendaComponent.prototype.onCancelar = function () {
        this.cancelarTramite.emit(true);
    };
    NewRnmaTramiteLevantamientoAlertaPrendaComponent.prototype.onKeyAcreedor = function () {
        var token = this._loginService.getToken();
        var nombreAcreedor = {
            'nombreAcreedor': this.nombreAcreedor,
        };
    };
    NewRnmaTramiteLevantamientoAlertaPrendaComponent.prototype.onKeyCiudadano = function () {
        var _this = this;
        var token = this._loginService.getToken();
        var identificacion = {
    ...
    NewRnmaTramiteLevantamientoAlertaPrendaComponent.prototype.onKeyApoderado = function () {
        var _this = this;
        var token = this._loginService.getToken();
        var identificacion = {
    ...
    NewRnmaTramiteLevantamientoAlertaPrendaComponent.prototype.onKeyEmpresa = function () {
        var _this = this;
        var token = this._loginService.getToken();
        var nit = {
            'nit': this.nit,
    ...
    NewRnmaTramiteLevantamientoAlertaPrendaComponent.prototype.goEmpresa = function () {
        this.router.navigate(['/dashboard/empresa']);
    };
    NewRnmaTramiteLevantamientoAlertaPrendaComponent.prototype.btnCancelarAcreedor = function () {
        this.acreedorEncontrado = 1;
    };
    NewRnmaTramiteLevantamientoAlertaPrendaComponent.prototype.btnNewCiudadano = function () {
    ...
    NewRnmaTramiteLevantamientoAlertaPrendaComponent.prototype.btnNewEmpresa = function () {
    ...
    NewRnmaTramiteLevantamientoAlertaPrendaComponent.prototype.btnCancelarCiudadano = function () {
        this.ciudadanoEncontrado = 1;
    };
    NewRnmaTramiteLevantamientoAlertaPrendaComponent.prototype.btnCancelarEmpresa = function () {
        this.empresaEncontrada = 1;
    };
    NewRnmaTramiteLevantamientoAlertaPrendaComponent.prototype.btnNewAcreedor = function () {
        var _this = this;
    ...
    NewRnmaTramiteLevantamientoAlertaPrendaComponent.prototype.changedtipoIdentificacion = function (e) {
        this.ciudadanoEncontrado = 1;
        this.empresaEncontrada = 1;
    };
    NewRnmaTramiteLevantamientoAlertaPrendaComponent.prototype.delete = function (acreedor) {
    ...
    NewRnmaTramiteLevantamientoAlertaPrendaComponent.prototype.deleteEmpresa = function (empresa) {
    ...
    NewRnmaTramiteLevantamientoAlertaPrendaComponent.prototype.ready = function (isCreado) {
        if (isCreado) {
    ...
    return NewRnmaTramiteLevantamientoAlertaPrendaComponent;
}());
__decorate([
    core_1.Output(),
    __metadata("design:type", Object)
], NewRnmaTramiteLevantamientoAlertaPrendaComponent.prototype, "readyTramite", void 0);
__decorate([
    core_1.Output(),
    __metadata("design:type", Object)
], NewRnmaTramiteLevantamientoAlertaPrendaComponent.prototype, "cancelarTramite", void 0);
__decorate([
    core_1.Input(),
    __metadata("design:type", Object)
], NewRnmaTramiteLevantamientoAlertaPrendaComponent.prototype, "vehiculo", void 0);
__decorate([
    core_1.Input(),
    __metadata("design:type", Object)
], NewRnmaTramiteLevantamientoAlertaPrendaComponent.prototype, "banco", void 0);
__decorate([
    core_1.Input(),
    __metadata("design:type", Object)
], NewRnmaTramiteLevantamientoAlertaPrendaComponent.prototype, "factura", void 0);
__decorate([
    core_1.Input(),
    __metadata("design:type", Object)
], NewRnmaTramiteLevantamientoAlertaPrendaComponent.prototype, "tramitesFactura", void 0);
NewRnmaTramiteLevantamientoAlertaPrendaComponent = __decorate([
    core_1.Component({
        selector: 'appRnma-levantamiento-alerta-prenda',
        templateUrl: './newRnma.levantamientoAlertaPrenda.html'
    }),
...
exports.NewRnmaTramiteLevantamientoAlertaPrendaComponent = NewRnmaTramiteLevantamientoAlertaPrendaComponent;
//# sourceMappingURL=newRnma.levantamientoAlertaPrenda.component.js.map