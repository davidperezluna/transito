...
var NewRnmaRegrabarChasisComponent = (function () {
    function NewRnmaRegrabarChasisComponent(_TramiteSolicitudService, _loginService, _SustratoService, _VehiculoService) {
    ...
    NewRnmaRegrabarChasisComponent.prototype.ngOnInit = function () {
        var _this = this;
    ...
    NewRnmaRegrabarChasisComponent.prototype.enviarTramite = function () {
        var _this = this;
        ...
        this._VehiculoService.editVehiculo(this.vehiculo, token).subscribe(function (response) {
            ...
            if (_this.respuesta.status == 'success') {
                ...
                _this.datos.tramiteFormulario = 'rnma-regrabarchasis';
    ...
    NewRnmaRegrabarChasisComponent.prototype.onCancelar = function () {
        this.cancelarTramite.emit(true);
    };
    return NewRnmaRegrabarChasisComponent;
}());
__decorate([
    core_1.Output(),
    __metadata("design:type", Object)
], NewRnmaRegrabarChasisComponent.prototype, "readyTramite", void 0);
__decorate([
    core_1.Output(),
    __metadata("design:type", Object)
], NewRnmaRegrabarChasisComponent.prototype, "cancelarTramite", void 0);
__decorate([
    core_1.Input(),
    __metadata("design:type", Object)
], NewRnmaRegrabarChasisComponent.prototype, "vehiculo", void 0);
__decorate([
    core_1.Input(),
    __metadata("design:type", Object)
], NewRnmaRegrabarChasisComponent.prototype, "factura", void 0);
NewRnmaRegrabarChasisComponent = __decorate([
    core_1.Component({
...
exports.NewRnmaRegrabarChasisComponent = NewRnmaRegrabarChasisComponent;
//# sourceMappingURL=newRnma.regrabarChasis.component.js.map