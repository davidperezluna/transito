...
var NewRnmaMatricualaInicialComponent = (function () {
    function NewRnmaMatricualaInicialComponent(_ColorService, _TramiteSolicitudService, _loginService, _tramiteFacturaService, _VehiculoService, _tipoIdentificacionService, _CiudadanoService, _CiudadanoVehiculoService, router, _EmpresaService) {
    ...
    NewRnmaMatricualaInicialComponent.prototype.ngOnInit = function () {
        var _this = this;
    ...
    NewRnmaMatricualaInicialComponent.prototype.enviarTramite = function () {
        var _this = this;
        ...
        this._CiudadanoVehiculoService.register(token, this.datos, this.tipoPropiedadSelected).subscribe(function (response) {
            ...
            _this.datos.tramiteFormulario = 'rnma-matriculainicial';
    ...
    NewRnmaMatricualaInicialComponent.prototype.onCancelar = function () {
        this.cancelarTramite.emit(true);
    };
    NewRnmaMatricualaInicialComponent.prototype.onKeyCiudadano = function () {
        var _this = this;
        var token = this._loginService.getToken();
        var identificacion = {
    ...
    NewRnmaMatricualaInicialComponent.prototype.onKeyApoderado = function () {
        var _this = this;
        var token = this._loginService.getToken();
        var identificacion = {
    ...
    NewRnmaMatricualaInicialComponent.prototype.onKeyEmpresa = function () {
        var _this = this;
        var token = this._loginService.getToken();
        var nit = {
            'nit': this.nit,
    ...
    NewRnmaMatricualaInicialComponent.prototype.goEmpresa = function () {
        this.router.navigate(['/dashboard/empresa']);
    };
    NewRnmaMatricualaInicialComponent.prototype.btnNewCiudadano = function () {
    ...
    NewRnmaMatricualaInicialComponent.prototype.btnNewEmpresa = function () {
        if (this.tipoPropiedadSelected == 2) {
    ...
    NewRnmaMatricualaInicialComponent.prototype.btnNewApoderado = function () {
        var _this = this;
    ...
    NewRnmaMatricualaInicialComponent.prototype.changedtipoIdentificacion = function (e) {
        this.ciudadanoEncontrado = 1;
        this.empresaEncontrada = 1;
    };
    NewRnmaMatricualaInicialComponent.prototype.btnCancelarCiudadano = function () {
        this.ciudadanoEncontrado = 1;
    };
    NewRnmaMatricualaInicialComponent.prototype.btnCancelarEmpresa = function () {
        this.empresaEncontrada = 1;
    };
    NewRnmaMatricualaInicialComponent.prototype.delete = function (ciudadano) {
    ...
    NewRnmaMatricualaInicialComponent.prototype.deleteEmpresa = function (empresa) {
    ...
    NewRnmaMatricualaInicialComponent.prototype.ready = function (isCreado) {
        if (isCreado) {
    ...
    NewRnmaMatricualaInicialComponent.prototype.agregarApoderadoCiudadano = function (ciudadano) {
    ...
    NewRnmaMatricualaInicialComponent.prototype.agregarApoderadoEmpresa = function (empresa) {
    ...
    NewRnmaMatricualaInicialComponent.prototype.onCancelarApoderado = function () {
        this.apoderado = 'false';
        this.tipoIdentificacionSelected = [this.tipoIdentificacionSelected];
        console.log(this.tipoIdentificacionSelected);
    };
    return NewRnmaMatricualaInicialComponent;
}());
__decorate([
    core_1.Output(),
    __metadata("design:type", Object)
], NewRnmaMatricualaInicialComponent.prototype, "readyTramite", void 0);
__decorate([
    core_1.Output(),
    __metadata("design:type", Object)
], NewRnmaMatricualaInicialComponent.prototype, "cancelarTramite", void 0);
__decorate([
    core_1.Input(),
    __metadata("design:type", Object)
], NewRnmaMatricualaInicialComponent.prototype, "vehiculo", void 0);
__decorate([
    core_1.Input(),
    __metadata("design:type", Object)
], NewRnmaMatricualaInicialComponent.prototype, "factura", void 0);
NewRnmaMatricualaInicialComponent = __decorate([
    core_1.Component({
...
exports.NewRnmaMatricualaInicialComponent = NewRnmaMatricualaInicialComponent;
//# sourceMappingURL=newRnma.matriculaInicial.component.js.map