...
var NewRnmaRegrabarSerieComponent = (function () {
    function NewRnmaRegrabarSerieComponent(_TramiteSolicitudService, _loginService, _SustratoService, _VehiculoService) {
    ...
    NewRnmaRegrabarSerieComponent.prototype.ngOnInit = function () {
        var _this = this;
    ...
    NewRnmaRegrabarSerieComponent.prototype.enviarTramite = function () {
        var _this = this;
        ...
        this._VehiculoService.editVehiculo(this.vehiculo, token).subscribe(function (response) {
            ...
            if (_this.respuesta.status == 'success') {
                ...
                _this.datos.tramiteFormulario = 'rnma-regrabarserie';
    ...
    NewRnmaRegrabarSerieComponent.prototype.onCancelar = function () {
        this.cancelarTramite.emit(true);
    };
    return NewRnmaRegrabarSerieComponent;
}());
__decorate([
    core_1.Output(),
    __metadata("design:type", Object)
], NewRnmaRegrabarSerieComponent.prototype, "readyTramite", void 0);
__decorate([
    core_1.Output(),
    __metadata("design:type", Object)
], NewRnmaRegrabarSerieComponent.prototype, "cancelarTramite", void 0);
__decorate([
    core_1.Input(),
    __metadata("design:type", Object)
], NewRnmaRegrabarSerieComponent.prototype, "vehiculo", void 0);
__decorate([
    core_1.Input(),
    __metadata("design:type", Object)
], NewRnmaRegrabarSerieComponent.prototype, "factura", void 0);
NewRnmaRegrabarSerieComponent = __decorate([
    core_1.Component({
...
exports.NewRnmaRegrabarSerieComponent = NewRnmaRegrabarSerieComponent;
//# sourceMappingURL=newRnma.regrabarSerie.component.js.map