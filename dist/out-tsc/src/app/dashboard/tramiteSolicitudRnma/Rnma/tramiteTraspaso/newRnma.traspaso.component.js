...
var NewRnmaTraspasoComponent = (function () {
    function NewRnmaTraspasoComponent(_ColorService, _TramiteSolicitudService, _loginService, _tramiteFacturaService, _VehiculoService, _tipoIdentificacionService, _CiudadanoService, _CiudadanoVehiculoService, router, _EmpresaService) {
    ...
    NewRnmaTraspasoComponent.prototype.ngOnInit = function () {
        var _this = this;
    ...
    NewRnmaTraspasoComponent.prototype.enviarTramite = function () {
        var _this = this;
        ...
        this._CiudadanoVehiculoService.register(token, this.datos, this.tipoPropiedadSelected).subscribe(function (response) {
            ...
            _this.datos.tramiteFormulario = 'rnma-traspaso';
    ...
    NewRnmaTraspasoComponent.prototype.onCancelar = function () {
        this.cancelarTramite.emit(true);
    };
    NewRnmaTraspasoComponent.prototype.onKeyCiudadano = function () {
        var _this = this;
        var token = this._loginService.getToken();
        var identificacion = {
    ...
    NewRnmaTraspasoComponent.prototype.onKeyApoderado = function () {
        var _this = this;
        var token = this._loginService.getToken();
        var identificacion = {
    ...
    NewRnmaTraspasoComponent.prototype.onKeyEmpresa = function () {
        var _this = this;
        var token = this._loginService.getToken();
        var nit = {
            'nit': this.nit,
    ...
    NewRnmaTraspasoComponent.prototype.goEmpresa = function () {
        this.router.navigate(['/dashboard/empresa']);
    };
    NewRnmaTraspasoComponent.prototype.btnNewCiudadano = function () {
    ...
    NewRnmaTraspasoComponent.prototype.btnNewEmpresa = function () {
        if (this.tipoPropiedadSelected == 2) {
    ...
    NewRnmaTraspasoComponent.prototype.btnNewApoderado = function () {
        var _this = this;
    ...
    NewRnmaTraspasoComponent.prototype.changedtipoIdentificacion = function (e) {
        this.ciudadanoEncontrado = 1;
        this.empresaEncontrada = 1;
    };
    NewRnmaTraspasoComponent.prototype.btnCancelarCiudadano = function () {
        this.ciudadanoEncontrado = 1;
    };
    NewRnmaTraspasoComponent.prototype.btnCancelarEmpresa = function () {
        this.empresaEncontrada = 1;
    };
    NewRnmaTraspasoComponent.prototype.delete = function (ciudadano) {
    ...
    NewRnmaTraspasoComponent.prototype.deleteEmpresa = function (empresa) {
    ...
    NewRnmaTraspasoComponent.prototype.ready = function (isCreado) {
        if (isCreado) {
    ...
    NewRnmaTraspasoComponent.prototype.agregarApoderadoCiudadano = function (ciudadano) {
        this.apoderado = 'ciudadano';
        this.ciudadanoSelected = this.datos.propietariosCiudadanos.filter(function (h) { return h == ciudadano; });
    };
    NewRnmaTraspasoComponent.prototype.agregarApoderadoEmpresa = function (empresa) {
        this.apoderado = 'empresa';
        this.empresaSelected = this.datos.propietariosEmpresas.filter(function (h) { return h == empresa; });
    };
    NewRnmaTraspasoComponent.prototype.onCancelarApoderado = function () {
        this.apoderado = 'false';
        this.tipoIdentificacionSelected = [this.tipoIdentificacionSelected];
    };
    return NewRnmaTraspasoComponent;
}());
__decorate([
    core_1.Output(),
    __metadata("design:type", Object)
], NewRnmaTraspasoComponent.prototype, "readyTramite", void 0);
__decorate([
    core_1.Output(),
    __metadata("design:type", Object)
], NewRnmaTraspasoComponent.prototype, "cancelarTramite", void 0);
__decorate([
    core_1.Input(),
    __metadata("design:type", Object)
], NewRnmaTraspasoComponent.prototype, "vehiculo", void 0);
__decorate([
    core_1.Input(),
    __metadata("design:type", Object)
], NewRnmaTraspasoComponent.prototype, "factura", void 0);
NewRnmaTraspasoComponent = __decorate([
    core_1.Component({
...
exports.NewRnmaTraspasoComponent = NewRnmaTraspasoComponent;
//# sourceMappingURL=newRnma.traspaso.component.js.map