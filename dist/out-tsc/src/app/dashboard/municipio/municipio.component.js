...
var MunicipioComponent = /** @class */ (function () {
    function MunicipioComponent(_MunicipioService, _loginService) {
    ...
    MunicipioComponent.prototype.iniciarTabla = function () {
    ...
    MunicipioComponent.prototype.onNew = function () {
        this.formNew = true;
        this.formIndex = false;
        this.table.destroy();
    };
    MunicipioComponent.prototype.ready = function (isCreado) {
        if (isCreado) {
            this.formNew = false;
            this.formEdit = false;
            this.formIndex = true;
    ...
    MunicipioComponent.prototype.deleteMunicipio = function (id) {
        var _this = this;
        sweetalert2_1.default({
            title: '¿Estás seguro?',
            ...
            if (result.value) {
                ...
                _this._MunicipioService.deleteMunicipio(token, id).subscribe(function (response) {
                    sweetalert2_1.default({
                        title: 'Eliminado!',
    ...
    MunicipioComponent.prototype.editMunicipio = function (municipio) {
