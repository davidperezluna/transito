...
var EditComponent = /** @class */ (function () {
    function EditComponent(_municipioService, _loginService, _departamentoService) {
    ...
    EditComponent.prototype.ngOnInit = function () {
        ...
        this._departamentoService.getDepartamentoSelect().subscribe(function (response) {
            ...
            setTimeout(function () {
                _this.departamentoSelected = [_this.municipio.departamento.id];
    ...
    __decorate([
        core_1.Input(),
        __metadata("design:type", Object)
    ], EditComponent.prototype, "municipio", void 0);
