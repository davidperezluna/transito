...
var municipio_modelo_1 = require("../municipio.modelo");
...
var NewComponent = /** @class */ (function () {
    function NewComponent(_MunicipioService, _loginService, _marcaService) {
    ...
    NewComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.municipio = new municipio_modelo_1.Municipio(null, null, null, null);
        this._marcaService.getDepartamentoSelect().subscribe(function (response) {
    ...
    NewComponent.prototype.onEnviar = function () {
        ...
        this._MunicipioService.register(this.municipio, token).subscribe(function (response) {
            ...
            if (_this.respuesta.status == 'success') {
                ...
                sweetalert2_1.default({
                    title: 'Error!',
                    text: 'El municipio ' + _this.municipio.nombre + ' ya se encuentra registrado',
                    type: 'error',
                    confirmButtonText: 'Aceptar'
                });
            }
