...
var carroceria_modelo_1 = require("../carroceria.modelo");
...
var NewComponent = (function () {
    function NewComponent(_CarroceriaService, _loginService, _claseService) {
    ...
    NewComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.carroceria = new carroceria_modelo_1.Carroceria(null, null, null, null);
    ...
    NewComponent.prototype.onEnviar = function () {
        ...
        this._CarroceriaService.register(this.carroceria, token).subscribe(function (response) {
            ...
            if (_this.respuesta.status == 'success') {
                ...
                sweetalert2_1.default({
                    title: 'Error!',
                    text: 'la carroceria ' + _this.carroceria.codigoMt + ' ya se encuentra registrado',
                    type: 'error',
                    confirmButtonText: 'Aceptar'
                });
            }
