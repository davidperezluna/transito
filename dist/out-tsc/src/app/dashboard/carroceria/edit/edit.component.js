...
var EditComponent = (function () {
    function EditComponent(_carroceriaService, _loginService, _claseService) {
    ...
    EditComponent.prototype.ngOnInit = function () {
        ...
        this._claseService.getClaseSelect().subscribe(function (response) {
            ...
            setTimeout(function () {
                _this.claseSelected = [_this.carroceria.clase.id];
    ...
    EditComponent.prototype.onEnviar = function () {
        ...
        this._carroceriaService.editCarroceria(this.carroceria, token).subscribe(function (response) {
...
__decorate([
    core_1.Input(),
    __metadata("design:type", Object)
], EditComponent.prototype, "carroceria", void 0);
