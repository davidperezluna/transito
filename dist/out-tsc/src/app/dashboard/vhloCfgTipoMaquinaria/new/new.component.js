...
var vhloCfgTipoMaquinaria_modelo_1 = require("../vhloCfgTipoMaquinaria.modelo");
var vhloCfgTipoMaquinaria_service_1 = require("../../../services/vhloCfgTipoMaquinaria.service");
var login_service_1 = require("../../../services/login.service");
var sweetalert2_1 = require("sweetalert2");
var NewComponent = (function () {
    function NewComponent(_TipoMaquinariaService, _loginService) {
        this._TipoMaquinariaService = _TipoMaquinariaService;
        this._loginService = _loginService;
        this.ready = new core_1.EventEmitter();
    }
    NewComponent.prototype.ngOnInit = function () {
        this.tipoMaquinaria = new vhloCfgTipoMaquinaria_modelo_1.VhloCfgTipoMaquinaria(null, null, null);
    };
    ...
    NewComponent.prototype.onEnviar = function () {
        ...
        this._TipoMaquinariaService.register(this.tipoMaquinaria, token).subscribe(function (response) {
