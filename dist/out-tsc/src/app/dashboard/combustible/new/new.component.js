...
var combustible_modelo_1 = require("../combustible.modelo");
var combustible_service_1 = require("../../../services/combustible.service");
var login_service_1 = require("../../../services/login.service");
var sweetalert2_1 = require("sweetalert2");
var NewComponent = (function () {
    function NewComponent(_CombustibleService, _loginService) {
        this._CombustibleService = _CombustibleService;
        this._loginService = _loginService;
        this.ready = new core_1.EventEmitter();
    }
    NewComponent.prototype.ngOnInit = function () {
        this.combustible = new combustible_modelo_1.Combustible(null, null, null);
    };
    ...
    NewComponent.prototype.onEnviar = function () {
        ...
        this._CombustibleService.register(this.combustible, token).subscribe(function (response) {
            ...
            if (_this.respuesta.status == 'success') {
                ...
                sweetalert2_1.default({
                    title: 'Error!',
                    text: 'El combustible ' + _this.combustible.nombre + ' ya se encuentra registrado',
                    type: 'error',
                    confirmButtonText: 'Aceptar'
                });
            }
