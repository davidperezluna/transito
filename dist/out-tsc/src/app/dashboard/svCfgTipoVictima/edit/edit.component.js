...
var EditComponent = (function () {
    function EditComponent(_TipoVictimaService, _loginService) {
        this._TipoVictimaService = _TipoVictimaService;
        this._loginService = _loginService;
        this.ready = new core_1.EventEmitter();
        this.tipoVictima = null;
    ...
    EditComponent.prototype.onEnviar = function () {
        ...
        this._TipoVictimaService.edit(this.tipoVictima, token).subscribe(function (response) {
...
__decorate([
    core_1.Input(),
    __metadata("design:type", Object)
], EditComponent.prototype, "tipoVictima", void 0);
