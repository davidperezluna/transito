...
var EditComponent = (function () {
    function EditComponent(_lineaService, _loginService, _marcaService) {
    ...
    EditComponent.prototype.ngOnInit = function () {
        ...
        this._marcaService.getMarcaSelect().subscribe(function (response) {
            ...
            setTimeout(function () {
                _this.marcaSelected = [_this.linea.marca.id];
    ...
    EditComponent.prototype.onEnviar = function () {
        ...
        this._lineaService.edit(this.linea, token).subscribe(function (response) {
...
__decorate([
    core_1.Input(),
    __metadata("design:type", Object)
], EditComponent.prototype, "linea", void 0);
