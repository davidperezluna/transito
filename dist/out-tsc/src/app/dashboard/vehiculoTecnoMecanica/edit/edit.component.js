...
var EditComponent = (function () {
    function EditComponent(_TecnoMecanicaService, _loginService) {
        this._TecnoMecanicaService = _TecnoMecanicaService;
        this._loginService = _loginService;
        this.ready = new core_1.EventEmitter();
        this.tecnoMecanica = null;
    ...
    EditComponent.prototype.onEnviar = function () {
        ...
        this._TecnoMecanicaService.edit(this.tecnoMecanica, token).subscribe(function (response) {
...
__decorate([
    core_1.Input(),
    __metadata("design:type", Object)
], EditComponent.prototype, "tecnoMecanica", void 0);
