...
var EditComponent = (function () {
    function EditComponent(_tramiteSolicitudService, _loginService, _tramiteFacturaService) {
    ...
    EditComponent.prototype.onEnviar = function () {
        ...
        this._tramiteSolicitudService.editTramiteSolicitud(this.tramiteSolicitud, token).subscribe(function (response) {
...
__decorate([
    core_1.Input(),
    __metadata("design:type", Object)
], EditComponent.prototype, "tramiteSolicitud", void 0);
