...
var tramiteSolicitud_modelo_1 = require("../tramiteSolicitud.modelo");
...
var NewRnaComponent = (function () {
    function NewRnaComponent(_TramiteSolicitudService, _loginService, _tramiteFacturaService, _facturaService, _ciudadanoVehiculoService, _ciudadanoService) {
    ...
    NewRnaComponent.prototype.ngOnInit = function () {
        ...
        this.tramiteSolicitud = new tramiteSolicitud_modelo_1.TramiteSolicitud(null, null, null, null, null, null, null, null);
    };
    NewRnaComponent.prototype.onCancelar = function () {
        this.ready.emit(true);
    };
    NewRnaComponent.prototype.onEnviar = function () {
        var _this = this;
    ...
    NewRnaComponent.prototype.onSearchFactura = function (id) {
        var _this = this;
        if (id) {
    ...
    NewRnaComponent.prototype.onKeyValidateVehiculo = function () {
        var _this = this;
        this.msj = '';
        this.mensaje = '';
        sweetalert2_1.default({
            ...
            if (response.status == 'error') {
                ...
                if (response.code == 401) {
                    ...
                    _this._facturaService.showFacturaByVehiculo(token, dato).subscribe(function (response) {
                        if (response.status == 'success') {
                            ...
                            _this.mensaje = 'No hay facturas para el vehÍculo';
                            _this.isError = true;
                            _this.vehiculoSuccess = false;
                            _this.factura = false;
                            sweetalert2_1.default.close();
                ...
                _this._facturaService.showFacturaByVehiculo(token, dato).subscribe(function (response) {
                    if (response.status == 'success') {
                        ...
                        _this.facturas = false;
                        _this.mensaje = 'No hay facturas para el vehiculo';
                        _this.isError = true;
                        _this.vehiculoSuccess = false;
                        _this.factura = false;
                        sweetalert2_1.default.close();
    ...
    NewRnaComponent.prototype.readyTramite = function (datos) {
        var _this = this;
        ...
        this._TramiteSolicitudService.register(this.tramiteSolicitud, token).subscribe(function (response) {
            ...
            if (_this.respuesta.status == 'success') {
                ...
                _this.error = false;
                _this.onSearchFactura(_this.factura.id);
            }
            else {
                sweetalert2_1.default({
                    title: 'Error!',
    ...
    NewRnaComponent.prototype.cancelarTramite = function () {
        this.tramiteSelected = false;
        this.error = false;
    };
    NewRnaComponent.prototype.finalizarSolicitud = function () {
        var _this = this;
        var token = this._loginService.getToken();
        this.tramites = '';
    ...
    NewRnaComponent.prototype.agregarApoderado = function () {
        this.frmApoderado = true;
    };
    NewRnaComponent.prototype.btnNewApoderado = function () {
        this.frmApoderado = false;
        this.apoderado = this.apoderadoSelect;
        this.apoderadoEncontrado = 1;
    };
    NewRnaComponent.prototype.onKeyApoderado = function () {
        var _this = this;
        var token = this._loginService.getToken();
        var identificacion = {
    ...
    NewRnaComponent.prototype.cerrarApoderado = function () {
        this.frmApoderado = false;
        this.apoderado = false;
        this.apoderadoEncontrado = 1;
    };
    return NewRnaComponent;
}());
__decorate([
    core_1.Output(),
    __metadata("design:type", Object)
], NewRnaComponent.prototype, "ready", void 0);
NewRnaComponent = __decorate([
    core_1.Component({
        selector: 'app-new',
...
exports.NewRnaComponent = NewRnaComponent;
//# sourceMappingURL=newRna.component.js.map