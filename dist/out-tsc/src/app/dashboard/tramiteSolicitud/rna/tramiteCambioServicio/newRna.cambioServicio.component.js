...
var NewRnaCambioServicioComponent = (function () {
    function NewRnaCambioServicioComponent(_ServicioService, _TramiteSolicitudService, _loginService, _VehiculoService) {
    ...
    NewRnaCambioServicioComponent.prototype.ngOnInit = function () {
        var _this = this;
    ...
    NewRnaCambioServicioComponent.prototype.enviarTramite = function () {
        var _this = this;
        ...
        this._ServicioService.showServicio(token, this.servicioSelected).subscribe(function (servicio) {
            ...
            _this.datos.tramiteFormulario = 'rna-cambioservicio';
    ...
    NewRnaCambioServicioComponent.prototype.onCancelar = function () {
        this.cancelarTramite.emit(true);
    };
    return NewRnaCambioServicioComponent;
}());
__decorate([
    core_1.Output(),
    __metadata("design:type", Object)
], NewRnaCambioServicioComponent.prototype, "readyTramite", void 0);
__decorate([
    core_1.Output(),
    __metadata("design:type", Object)
], NewRnaCambioServicioComponent.prototype, "cancelarTramite", void 0);
__decorate([
    core_1.Input(),
    __metadata("design:type", Object)
], NewRnaCambioServicioComponent.prototype, "vehiculo", void 0);
__decorate([
    core_1.Input(),
    __metadata("design:type", Object)
], NewRnaCambioServicioComponent.prototype, "factura", void 0);
NewRnaCambioServicioComponent = __decorate([
    core_1.Component({
...
exports.NewRnaCambioServicioComponent = NewRnaCambioServicioComponent;
//# sourceMappingURL=newRna.cambioServicio.component.js.map