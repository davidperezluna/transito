...
var NewRnaCambioColorComponent = (function () {
    function NewRnaCambioColorComponent(_ColorService, _TramiteSolicitudService, _loginService, _TramiteFacturaService, _VehiculoService) {
    ...
    NewRnaCambioColorComponent.prototype.ngOnInit = function () {
        var _this = this;
    ...
    NewRnaCambioColorComponent.prototype.enviarTramite = function () {
        var _this = this;
        var token = this._loginService.getToken();
        this._ColorService.show(token, this.colorSelected).subscribe(function (color) {
            ...
            _this._VehiculoService.editVehiculoColor(_this.vehiculo, token).subscribe(function (response) {
                ...
                if (_this.respuesta.status == 'success') {
                    ...
                    _this.datos.tramiteFormulario = 'rna-cambiocolor';
    ...
    NewRnaCambioColorComponent.prototype.onCancelar = function () {
        this.cancelarTramite.emit(true);
    };
    return NewRnaCambioColorComponent;
}());
__decorate([
    core_1.Output(),
    __metadata("design:type", Object)
], NewRnaCambioColorComponent.prototype, "readyTramite", void 0);
__decorate([
    core_1.Output(),
    __metadata("design:type", Object)
], NewRnaCambioColorComponent.prototype, "cancelarTramite", void 0);
__decorate([
    core_1.Input(),
    __metadata("design:type", Object)
], NewRnaCambioColorComponent.prototype, "vehiculo", void 0);
__decorate([
    core_1.Input(),
    __metadata("design:type", Object)
], NewRnaCambioColorComponent.prototype, "factura", void 0);
NewRnaCambioColorComponent = __decorate([
    core_1.Component({
...
exports.NewRnaCambioColorComponent = NewRnaCambioColorComponent;
//# sourceMappingURL=newRna.cambioColor.component.js.map