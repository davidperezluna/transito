...
var NewRnaTramiteLevantamientoAlertaPrendaComponent = (function () {
    function NewRnaTramiteLevantamientoAlertaPrendaComponent(_CfgTipoAlertaService, _TramiteSolicitudService, _BancoService, _loginService, _tramiteFacturaService, _VehiculoService, _VehiculoAcreedorService, _tipoIdentificacionService, _CiudadanoService, router, _EmpresaService) {
    ...
    ;
    NewRnaTramiteLevantamientoAlertaPrendaComponent.prototype.ngOnInit = function () {
        var _this = this;
    ...
    NewRnaTramiteLevantamientoAlertaPrendaComponent.prototype.enviarTramite = function () {
        var _this = this;
    ...
    NewRnaTramiteLevantamientoAlertaPrendaComponent.prototype.onCancelar = function () {
        this.cancelarTramite.emit(true);
    };
    NewRnaTramiteLevantamientoAlertaPrendaComponent.prototype.onKeyAcreedor = function () {
        var token = this._loginService.getToken();
        var nombreAcreedor = {
            'nombreAcreedor': this.nombreAcreedor,
        };
    };
    NewRnaTramiteLevantamientoAlertaPrendaComponent.prototype.onKeyCiudadano = function () {
        var _this = this;
        var token = this._loginService.getToken();
        var identificacion = {
    ...
    NewRnaTramiteLevantamientoAlertaPrendaComponent.prototype.onKeyApoderado = function () {
        var _this = this;
        var token = this._loginService.getToken();
        var identificacion = {
    ...
    NewRnaTramiteLevantamientoAlertaPrendaComponent.prototype.onKeyEmpresa = function () {
        var _this = this;
        var token = this._loginService.getToken();
        var nit = {
            'nit': this.nit,
    ...
    NewRnaTramiteLevantamientoAlertaPrendaComponent.prototype.goEmpresa = function () {
        this.router.navigate(['/dashboard/empresa']);
    };
    NewRnaTramiteLevantamientoAlertaPrendaComponent.prototype.btnCancelarAcreedor = function () {
        this.acreedorEncontrado = 1;
    };
    NewRnaTramiteLevantamientoAlertaPrendaComponent.prototype.btnNewCiudadano = function () {
    ...
    NewRnaTramiteLevantamientoAlertaPrendaComponent.prototype.btnNewEmpresa = function () {
    ...
    NewRnaTramiteLevantamientoAlertaPrendaComponent.prototype.btnCancelarCiudadano = function () {
        this.ciudadanoEncontrado = 1;
    };
    NewRnaTramiteLevantamientoAlertaPrendaComponent.prototype.btnCancelarEmpresa = function () {
        this.empresaEncontrada = 1;
    };
    NewRnaTramiteLevantamientoAlertaPrendaComponent.prototype.btnNewAcreedor = function () {
        var _this = this;
    ...
    NewRnaTramiteLevantamientoAlertaPrendaComponent.prototype.changedtipoIdentificacion = function (e) {
        this.ciudadanoEncontrado = 1;
        this.empresaEncontrada = 1;
    };
    NewRnaTramiteLevantamientoAlertaPrendaComponent.prototype.delete = function (acreedor) {
    ...
    NewRnaTramiteLevantamientoAlertaPrendaComponent.prototype.deleteEmpresa = function (empresa) {
    ...
    NewRnaTramiteLevantamientoAlertaPrendaComponent.prototype.ready = function (isCreado) {
        if (isCreado) {
    ...
    return NewRnaTramiteLevantamientoAlertaPrendaComponent;
}());
__decorate([
    core_1.Output(),
    __metadata("design:type", Object)
], NewRnaTramiteLevantamientoAlertaPrendaComponent.prototype, "readyTramite", void 0);
__decorate([
    core_1.Output(),
    __metadata("design:type", Object)
], NewRnaTramiteLevantamientoAlertaPrendaComponent.prototype, "cancelarTramite", void 0);
__decorate([
    core_1.Input(),
    __metadata("design:type", Object)
], NewRnaTramiteLevantamientoAlertaPrendaComponent.prototype, "vehiculo", void 0);
__decorate([
    core_1.Input(),
    __metadata("design:type", Object)
], NewRnaTramiteLevantamientoAlertaPrendaComponent.prototype, "banco", void 0);
__decorate([
    core_1.Input(),
    __metadata("design:type", Object)
], NewRnaTramiteLevantamientoAlertaPrendaComponent.prototype, "factura", void 0);
NewRnaTramiteLevantamientoAlertaPrendaComponent = __decorate([
    core_1.Component({
...
exports.NewRnaTramiteLevantamientoAlertaPrendaComponent = NewRnaTramiteLevantamientoAlertaPrendaComponent;
//# sourceMappingURL=newRna.levantamientoAlertaPrenda.component.js.map