...
var NewRnaTraspasoComponent = (function () {
    function NewRnaTraspasoComponent(_ColorService, _TramiteSolicitudService, _loginService, _tramiteFacturaService, _VehiculoService, _tipoIdentificacionService, _CiudadanoService, _CiudadanoVehiculoService, router, _EmpresaService) {
    ...
    NewRnaTraspasoComponent.prototype.ngOnInit = function () {
        var _this = this;
    ...
    NewRnaTraspasoComponent.prototype.enviarTramite = function () {
        var _this = this;
        ...
        this._CiudadanoVehiculoService.register(token, this.datos, this.tipoPropiedadSelected).subscribe(function (response) {
            ...
            _this.datos.tramiteFormulario = 'rna-traspaso';
    ...
    NewRnaTraspasoComponent.prototype.onCancelar = function () {
        this.cancelarTramite.emit(true);
    };
    NewRnaTraspasoComponent.prototype.onKeyCiudadano = function () {
        var _this = this;
        var token = this._loginService.getToken();
        var identificacion = {
    ...
    NewRnaTraspasoComponent.prototype.onKeyApoderado = function () {
        var _this = this;
        var token = this._loginService.getToken();
        var identificacion = {
    ...
    NewRnaTraspasoComponent.prototype.onKeyEmpresa = function () {
        var _this = this;
        var token = this._loginService.getToken();
        var nit = {
            'nit': this.nit,
    ...
    NewRnaTraspasoComponent.prototype.goEmpresa = function () {
        this.router.navigate(['/dashboard/empresa']);
    };
    NewRnaTraspasoComponent.prototype.btnNewCiudadano = function () {
    ...
    NewRnaTraspasoComponent.prototype.btnNewEmpresa = function () {
        if (this.tipoPropiedadSelected == 2) {
    ...
    NewRnaTraspasoComponent.prototype.btnNewApoderado = function () {
        var _this = this;
    ...
    NewRnaTraspasoComponent.prototype.changedtipoIdentificacion = function (e) {
        this.ciudadanoEncontrado = 1;
        this.empresaEncontrada = 1;
    };
    NewRnaTraspasoComponent.prototype.btnCancelarCiudadano = function () {
        this.ciudadanoEncontrado = 1;
    };
    NewRnaTraspasoComponent.prototype.btnCancelarEmpresa = function () {
        this.empresaEncontrada = 1;
    };
    NewRnaTraspasoComponent.prototype.delete = function (ciudadano) {
    ...
    NewRnaTraspasoComponent.prototype.deleteEmpresa = function (empresa) {
    ...
    NewRnaTraspasoComponent.prototype.ready = function (isCreado) {
        if (isCreado) {
    ...
    NewRnaTraspasoComponent.prototype.agregarApoderadoCiudadano = function (ciudadano) {
        this.apoderado = 'ciudadano';
        this.ciudadanoSelected = this.datos.propietariosCiudadanos.filter(function (h) { return h == ciudadano; });
    };
    NewRnaTraspasoComponent.prototype.agregarApoderadoEmpresa = function (empresa) {
        this.apoderado = 'empresa';
        this.empresaSelected = this.datos.propietariosEmpresas.filter(function (h) { return h == empresa; });
    };
    NewRnaTraspasoComponent.prototype.onCancelarApoderado = function () {
        this.apoderado = 'false';
        this.tipoIdentificacionSelected = [this.tipoIdentificacionSelected];
    };
    return NewRnaTraspasoComponent;
}());
__decorate([
    core_1.Output(),
    __metadata("design:type", Object)
], NewRnaTraspasoComponent.prototype, "readyTramite", void 0);
__decorate([
    core_1.Output(),
    __metadata("design:type", Object)
], NewRnaTraspasoComponent.prototype, "cancelarTramite", void 0);
__decorate([
    core_1.Input(),
    __metadata("design:type", Object)
], NewRnaTraspasoComponent.prototype, "vehiculo", void 0);
__decorate([
    core_1.Input(),
    __metadata("design:type", Object)
], NewRnaTraspasoComponent.prototype, "factura", void 0);
NewRnaTraspasoComponent = __decorate([
    core_1.Component({
...
exports.NewRnaTraspasoComponent = NewRnaTraspasoComponent;
//# sourceMappingURL=newRna.traspaso.component.js.map