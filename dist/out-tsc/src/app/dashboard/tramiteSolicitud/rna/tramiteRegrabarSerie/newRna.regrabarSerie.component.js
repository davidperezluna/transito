...
var NewRnaRegrabarSerieComponent = (function () {
    function NewRnaRegrabarSerieComponent(_TramiteSolicitudService, _loginService, _SustratoService, _VehiculoService) {
    ...
    NewRnaRegrabarSerieComponent.prototype.ngOnInit = function () {
        var _this = this;
    ...
    NewRnaRegrabarSerieComponent.prototype.enviarTramite = function () {
        var _this = this;
        ...
        this._VehiculoService.editVehiculo(this.vehiculo, token).subscribe(function (response) {
            ...
            if (_this.respuesta.status == 'success') {
                ...
                _this.datos.tramiteFormulario = 'rna-regrabarserie';
    ...
    NewRnaRegrabarSerieComponent.prototype.onCancelar = function () {
        this.cancelarTramite.emit(true);
    };
    return NewRnaRegrabarSerieComponent;
}());
__decorate([
    core_1.Output(),
    __metadata("design:type", Object)
], NewRnaRegrabarSerieComponent.prototype, "readyTramite", void 0);
__decorate([
    core_1.Output(),
    __metadata("design:type", Object)
], NewRnaRegrabarSerieComponent.prototype, "cancelarTramite", void 0);
__decorate([
    core_1.Input(),
    __metadata("design:type", Object)
], NewRnaRegrabarSerieComponent.prototype, "vehiculo", void 0);
__decorate([
    core_1.Input(),
    __metadata("design:type", Object)
], NewRnaRegrabarSerieComponent.prototype, "factura", void 0);
NewRnaRegrabarSerieComponent = __decorate([
    core_1.Component({
...
exports.NewRnaRegrabarSerieComponent = NewRnaRegrabarSerieComponent;
//# sourceMappingURL=newRna.regrabarSerie.component.js.map