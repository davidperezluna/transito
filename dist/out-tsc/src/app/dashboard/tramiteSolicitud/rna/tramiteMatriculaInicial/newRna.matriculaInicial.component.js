...
var NewRnaMatricualaInicialComponent = (function () {
    function NewRnaMatricualaInicialComponent(_ColorService, _TramiteSolicitudService, _loginService, _tramiteFacturaService, _VehiculoService, _tipoIdentificacionService, _CiudadanoService, _CiudadanoVehiculoService, router, _EmpresaService) {
    ...
    NewRnaMatricualaInicialComponent.prototype.ngOnInit = function () {
        var _this = this;
    ...
    NewRnaMatricualaInicialComponent.prototype.enviarTramite = function () {
        var _this = this;
    ...
    NewRnaMatricualaInicialComponent.prototype.onCancelar = function () {
        this.cancelarTramite.emit(true);
    };
    NewRnaMatricualaInicialComponent.prototype.onKeyCiudadano = function () {
        var _this = this;
        var token = this._loginService.getToken();
        var identificacion = {
    ...
    NewRnaMatricualaInicialComponent.prototype.onKeyApoderado = function () {
        var _this = this;
        var token = this._loginService.getToken();
        var identificacion = {
        ...
        this._CiudadanoService.searchByIdentificacion(token, identificacion).subscribe(function (response) {
            ...
            if (_this.respuesta.status == 'success') {
                ...
                _this.datos.tramiteFormulario = 'rna-matriculainicial';
            }
            else {
    ...
    NewRnaMatricualaInicialComponent.prototype.onKeyEmpresa = function () {
        var _this = this;
        var token = this._loginService.getToken();
        var nit = {
            'nit': this.nit,
    ...
    NewRnaMatricualaInicialComponent.prototype.goEmpresa = function () {
        this.router.navigate(['/dashboard/empresa']);
    };
    NewRnaMatricualaInicialComponent.prototype.btnNewCiudadano = function () {
    ...
    NewRnaMatricualaInicialComponent.prototype.btnNewEmpresa = function () {
        if (this.tipoPropiedadSelected == 2) {
    ...
    NewRnaMatricualaInicialComponent.prototype.btnNewApoderado = function () {
        var _this = this;
    ...
    NewRnaMatricualaInicialComponent.prototype.changedtipoIdentificacion = function (e) {
        this.ciudadanoEncontrado = 1;
        this.empresaEncontrada = 1;
    };
    NewRnaMatricualaInicialComponent.prototype.btnCancelarCiudadano = function () {
        this.ciudadanoEncontrado = 1;
    };
    NewRnaMatricualaInicialComponent.prototype.btnCancelarEmpresa = function () {
        this.empresaEncontrada = 1;
    };
    NewRnaMatricualaInicialComponent.prototype.delete = function (ciudadano) {
    ...
    NewRnaMatricualaInicialComponent.prototype.deleteEmpresa = function (empresa) {
    ...
    NewRnaMatricualaInicialComponent.prototype.ready = function (isCreado) {
        if (isCreado) {
    ...
    NewRnaMatricualaInicialComponent.prototype.agregarApoderadoCiudadano = function (ciudadano) {
    ...
    NewRnaMatricualaInicialComponent.prototype.agregarApoderadoEmpresa = function (empresa) {
    ...
    NewRnaMatricualaInicialComponent.prototype.onCancelarApoderado = function () {
        this.apoderado = 'false';
        this.tipoIdentificacionSelected = [this.tipoIdentificacionSelected];
        console.log(this.tipoIdentificacionSelected);
    };
    return NewRnaMatricualaInicialComponent;
}());
__decorate([
    core_1.Output(),
    __metadata("design:type", Object)
], NewRnaMatricualaInicialComponent.prototype, "readyTramite", void 0);
__decorate([
    core_1.Output(),
    __metadata("design:type", Object)
], NewRnaMatricualaInicialComponent.prototype, "cancelarTramite", void 0);
__decorate([
    core_1.Input(),
    __metadata("design:type", Object)
], NewRnaMatricualaInicialComponent.prototype, "vehiculo", void 0);
__decorate([
    core_1.Input(),
    __metadata("design:type", Object)
], NewRnaMatricualaInicialComponent.prototype, "factura", void 0);
NewRnaMatricualaInicialComponent = __decorate([
    core_1.Component({
...
exports.NewRnaMatricualaInicialComponent = NewRnaMatricualaInicialComponent;
//# sourceMappingURL=newRna.matriculaInicial.component.js.map