...
var NewRnaTraspasoIndeterminadaComponent = (function () {
    function NewRnaTraspasoIndeterminadaComponent(_TramiteSolicitudService, _loginService, _VehiculoService, _CiudadanoVehiculoService) {
    ...
    NewRnaTraspasoIndeterminadaComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.datos = {
            'fecha': null,
    ...
    NewRnaTraspasoIndeterminadaComponent.prototype.onNew = function () {
        this.formNew = true;
        this.formIndex = false;
        this.table.destroy();
    };
    NewRnaTraspasoIndeterminadaComponent.prototype.ready = function (isCreado) {
        if (isCreado) {
            this.formNew = false;
            this.formEdit = false;
            this.formIndex = true;
    ...
    NewRnaTraspasoIndeterminadaComponent.prototype.onEnviar = function () {
        var _this = this;
    ...
    return NewRnaTraspasoIndeterminadaComponent;
}());
__decorate([
    core_1.Output(),
    __metadata("design:type", Object)
], NewRnaTraspasoIndeterminadaComponent.prototype, "readyTramite", void 0);
__decorate([
    core_1.Input(),
    __metadata("design:type", Object)
], NewRnaTraspasoIndeterminadaComponent.prototype, "vehiculo", void 0);
__decorate([
    core_1.Input(),
    __metadata("design:type", Object)
], NewRnaTraspasoIndeterminadaComponent.prototype, "factura", void 0);
__decorate([
    core_1.Input(),
    __metadata("design:type", Object)
], NewRnaTraspasoIndeterminadaComponent.prototype, "ciudadano", void 0);
NewRnaTraspasoIndeterminadaComponent = __decorate([
    core_1.Component({
...
exports.NewRnaTraspasoIndeterminadaComponent = NewRnaTraspasoIndeterminadaComponent;
//# sourceMappingURL=newRna.traspasoIndeterminada.component.js.map