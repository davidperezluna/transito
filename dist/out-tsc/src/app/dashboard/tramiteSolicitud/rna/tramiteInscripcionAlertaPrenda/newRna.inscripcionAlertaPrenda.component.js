...
var NewRnaTramiteInscripcionAlertaPrendaComponent = (function () {
    function NewRnaTramiteInscripcionAlertaPrendaComponent(_CfgEntidadJudicialService, _CfgTipoAlertaService, _TramiteSolicitudService, _BancoService, _loginService, _tramiteFacturaService, _VehiculoService, _VehiculoAcreedorService, _tipoIdentificacionService, _CiudadanoService, router, _EmpresaService) {
    ...
    NewRnaTramiteInscripcionAlertaPrendaComponent.prototype.ngOnInit = function () {
        var _this = this;
    ...
    NewRnaTramiteInscripcionAlertaPrendaComponent.prototype.enviarTramite = function () {
        var _this = this;
    ...
    NewRnaTramiteInscripcionAlertaPrendaComponent.prototype.onCancelar = function () {
    ...
    //     )
    // }
    NewRnaTramiteInscripcionAlertaPrendaComponent.prototype.onKeyAcreedor = function () {
        var _this = this;
        var token = this._loginService.getToken();
        var nombreAcreedor = {
    ...
    NewRnaTramiteInscripcionAlertaPrendaComponent.prototype.onKeyCiudadano = function () {
        var _this = this;
        var token = this._loginService.getToken();
        var identificacion = {
    ...
    NewRnaTramiteInscripcionAlertaPrendaComponent.prototype.onKeyApoderado = function () {
        var _this = this;
        var token = this._loginService.getToken();
        var identificacion = {
    ...
    NewRnaTramiteInscripcionAlertaPrendaComponent.prototype.onKeyEmpresa = function () {
        var _this = this;
        var token = this._loginService.getToken();
        var nit = {
            'nit': this.nit,
    ...
    NewRnaTramiteInscripcionAlertaPrendaComponent.prototype.goEmpresa = function () {
        this.router.navigate(['/dashboard/empresa']);
    };
    NewRnaTramiteInscripcionAlertaPrendaComponent.prototype.btnCancelarAcreedor = function () {
        this.acreedorEncontrado = 1;
    };
    NewRnaTramiteInscripcionAlertaPrendaComponent.prototype.btnNewCiudadano = function () {
    ...
    NewRnaTramiteInscripcionAlertaPrendaComponent.prototype.btnNewEmpresa = function () {
    ...
    NewRnaTramiteInscripcionAlertaPrendaComponent.prototype.btnNewAcreedor = function () {
        var _this = this;
    ...
    NewRnaTramiteInscripcionAlertaPrendaComponent.prototype.changedtipoIdentificacion = function (e) {
        this.ciudadanoEncontrado = 1;
        this.empresaEncontrada = 1;
    };
    NewRnaTramiteInscripcionAlertaPrendaComponent.prototype.delete = function (acreedor) {
    ...
    NewRnaTramiteInscripcionAlertaPrendaComponent.prototype.deleteEmpresa = function (empresa) {
    ...
    NewRnaTramiteInscripcionAlertaPrendaComponent.prototype.ready = function (isCreado) {
        if (isCreado) {
    ...
    NewRnaTramiteInscripcionAlertaPrendaComponent.prototype.btnCancelarCiudadano = function () {
        this.ciudadanoEncontrado = 1;
    };
    NewRnaTramiteInscripcionAlertaPrendaComponent.prototype.btnCancelarEmpresa = function () {
        this.empresaEncontrada = 1;
    };
    return NewRnaTramiteInscripcionAlertaPrendaComponent;
}());
__decorate([
    core_1.Output(),
    __metadata("design:type", Object)
], NewRnaTramiteInscripcionAlertaPrendaComponent.prototype, "readyTramite", void 0);
__decorate([
    core_1.Output(),
    __metadata("design:type", Object)
], NewRnaTramiteInscripcionAlertaPrendaComponent.prototype, "cancelarTramite", void 0);
__decorate([
    core_1.Input(),
    __metadata("design:type", Object)
], NewRnaTramiteInscripcionAlertaPrendaComponent.prototype, "vehiculo", void 0);
__decorate([
    core_1.Input(),
    __metadata("design:type", Object)
], NewRnaTramiteInscripcionAlertaPrendaComponent.prototype, "banco", void 0);
__decorate([
    core_1.Input(),
    __metadata("design:type", Object)
], NewRnaTramiteInscripcionAlertaPrendaComponent.prototype, "factura", void 0);
NewRnaTramiteInscripcionAlertaPrendaComponent = __decorate([
    core_1.Component({
...
exports.NewRnaTramiteInscripcionAlertaPrendaComponent = NewRnaTramiteInscripcionAlertaPrendaComponent;
//# sourceMappingURL=newRna.inscripcionAlertaPrenda.component.js.map