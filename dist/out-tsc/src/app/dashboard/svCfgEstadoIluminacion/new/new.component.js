...
var svCfgEstadoIluminacion_modelo_1 = require("../svCfgEstadoIluminacion.modelo");
var svCfgEstadoIluminacion_service_1 = require("../../../services/svCfgEstadoIluminacion.service");
var login_service_1 = require("../../../services/login.service");
var sweetalert2_1 = require("sweetalert2");
var NewComponent = (function () {
    function NewComponent(_EstadoIluminacionService, _loginService) {
        this._EstadoIluminacionService = _EstadoIluminacionService;
        this._loginService = _loginService;
        this.ready = new core_1.EventEmitter();
    }
    NewComponent.prototype.ngOnInit = function () {
        this.estadoIluminacion = new svCfgEstadoIluminacion_modelo_1.SvCfgEstadoIluminacion(null, null);
    };
    ...
    NewComponent.prototype.onEnviar = function () {
        ...
        this._EstadoIluminacionService.register(this.estadoIluminacion, token).subscribe(function (response) {
