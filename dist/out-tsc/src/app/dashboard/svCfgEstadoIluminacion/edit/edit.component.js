...
var EditComponent = (function () {
    function EditComponent(_EstadoIluminacionService, _loginService) {
        this._EstadoIluminacionService = _EstadoIluminacionService;
        this._loginService = _loginService;
        this.ready = new core_1.EventEmitter();
        this.estadoIluminacion = null;
    ...
    EditComponent.prototype.onEnviar = function () {
        ...
        this._EstadoIluminacionService.edit(this.estadoIluminacion, token).subscribe(function (response) {
...
__decorate([
    core_1.Input(),
    __metadata("design:type", Object)
], EditComponent.prototype, "estadoIluminacion", void 0);
