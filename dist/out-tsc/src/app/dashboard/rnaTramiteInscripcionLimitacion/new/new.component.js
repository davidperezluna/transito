...
var rnaTramiteInscripcionLimitacion_modelo_1 = require("../rnaTramiteInscripcionLimitacion.modelo");
...
var NewComponent = (function () {
    ...
    NewComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.rnaTramiteInscripcionLimitacion = new rnaTramiteInscripcionLimitacion_modelo_1.RnaTramiteInscripcionLimitacion(null, null, null, null, null, null, null, null, null, null, null, null, null);
    ...
    NewComponent.prototype.enviarTramite = function () {
        ...
        this._TramiteInscripcionLimitacionService.register(data, token).subscribe(function (response) {
            ...
            if (_this.respuesta.status == 'success') {
                ...
                sweetalert2_1.default({
                    title: 'Error!',
                    text: 'La limitacion a la propiedad ' + _this.vehiculo.placa.numero + ', con la fecha: ' + _this.rnaTramiteInscripcionLimitacion.fechaExpedicion + ', expedido por la entidad judicial: ' + eJudicial + ' ya se encuentra registrado',
                    type: 'error',
                    confirmButtonText: 'Aceptar'
                });
            }
