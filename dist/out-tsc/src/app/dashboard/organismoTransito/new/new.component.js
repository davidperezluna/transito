...
var organismoTransito_modelo_1 = require("../organismoTransito.modelo");
var organismoTransito_service_1 = require("../../../services/organismoTransito.service");
var login_service_1 = require("../../../services/login.service");
var sweetalert2_1 = require("sweetalert2");
var NewComponent = /** @class */ (function () {
    function NewComponent(_OrganismoTransitoService, _loginService) {
        this._OrganismoTransitoService = _OrganismoTransitoService;
        this._loginService = _loginService;
        this.ready = new core_1.EventEmitter();
    }
    NewComponent.prototype.ngOnInit = function () {
        this.organismoTransito = new organismoTransito_modelo_1.OrganismoTransito(null, null);
    };
    ...
    NewComponent.prototype.onEnviar = function () {
        ...
        this._OrganismoTransitoService.register(this.organismoTransito, token).subscribe(function (response) {
            ...
            if (_this.respuesta.status == 'success') {
                ...
                sweetalert2_1.default({
                    title: 'Error!',
                    text: 'El organismoTransito ' + _this.organismoTransito.nombre + ' ya se encuentra registrado',
                    type: 'error',
                    confirmButtonText: 'Aceptar'
                });
            }
