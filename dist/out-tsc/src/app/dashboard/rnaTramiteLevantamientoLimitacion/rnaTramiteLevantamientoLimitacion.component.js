...
var RnaTramiteLevantamientoLimitacionComponent = (function () {
    function RnaTramiteLevantamientoLimitacionComponent(_VehiculoLimitacionService, _VehiculoService, _loginService) {
    ...
    RnaTramiteLevantamientoLimitacionComponent.prototype.ngOnInit = function () {
        var _this = this;
    ...
    RnaTramiteLevantamientoLimitacionComponent.prototype.iniciarTabla = function () {
    ...
    RnaTramiteLevantamientoLimitacionComponent.prototype.ready = function (isCreado) {
        if (isCreado) {
            this.formIndex = true;
            this.ngOnInit();
        }
    };
    RnaTramiteLevantamientoLimitacionComponent.prototype.onKeyPlaca = function () {
        var _this = this;
    ...
    RnaTramiteLevantamientoLimitacionComponent.prototype.enviarTramite = function (limitacionVehiculo) {
        var _this = this;
        var token = this._loginService.getToken();
    ...
    RnaTramiteLevantamientoLimitacionComponent.prototype.onCancelar = function () {
        this.listaLimitacionVehiculo = false;
        this.limitacionVehiculoM = false;
        this.limitacionVehiculoEncontrada = 1;
    };
    RnaTramiteLevantamientoLimitacionComponent.prototype.ver = function (limitacionVehiculoP) {
        this.limitacionVehiculoM = true;
        this.limitacionVehiculoMostrar = limitacionVehiculoP;
        this.listaLimitacionVehiculo = false;
    };
    return RnaTramiteLevantamientoLimitacionComponent;
}());
RnaTramiteLevantamientoLimitacionComponent = __decorate([
    core_1.Component({
        selector: 'app-index',
...
], RnaTramiteLevantamientoLimitacionComponent);
exports.RnaTramiteLevantamientoLimitacionComponent = RnaTramiteLevantamientoLimitacionComponent;
//# sourceMappingURL=rnaTramiteLevantamientoLimitacion.component.js.map