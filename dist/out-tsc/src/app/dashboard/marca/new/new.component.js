...
var marca_modelo_1 = require("../marca.modelo");
var marca_service_1 = require("../../../services/marca.service");
var login_service_1 = require("../../../services/login.service");
var sweetalert2_1 = require("sweetalert2");
var NewComponent = /** @class */ (function () {
    function NewComponent(_MarcaService, _loginService) {
        this._MarcaService = _MarcaService;
        this._loginService = _loginService;
        this.ready = new core_1.EventEmitter();
    }
    NewComponent.prototype.ngOnInit = function () {
        this.marca = new marca_modelo_1.Marca(null, null, null);
    };
    ...
    NewComponent.prototype.onEnviar = function () {
        ...
        this._MarcaService.register(this.marca, token).subscribe(function (response) {
            ...
            if (_this.respuesta.status == 'success') {
                ...
                sweetalert2_1.default({
                    title: 'Error!',
                    text: 'El codigo ' + _this.marca.codigoMt + ' ya se encuentra registrado',
                    type: 'error',
                    confirmButtonText: 'Aceptar'
                });
            }
