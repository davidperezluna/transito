...
var svCfgDisenio_modelo_1 = require("../svCfgDisenio.modelo");
var svCfgDisenio_service_1 = require("../../../services/svCfgDisenio.service");
var login_service_1 = require("../../../services/login.service");
var sweetalert2_1 = require("sweetalert2");
var NewComponent = (function () {
    function NewComponent(_DisenioService, _loginService) {
        this._DisenioService = _DisenioService;
        this._loginService = _loginService;
        this.ready = new core_1.EventEmitter();
    }
    NewComponent.prototype.ngOnInit = function () {
        this.disenio = new svCfgDisenio_modelo_1.SvCfgDisenio(null, null);
    };
    ...
    NewComponent.prototype.onEnviar = function () {
        ...
        this._DisenioService.register(this.disenio, token).subscribe(function (response) {
