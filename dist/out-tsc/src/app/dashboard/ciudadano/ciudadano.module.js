...
var CiudadanoModule = /** @class */ (function () {
    function CiudadanoModule() {
    }
    CiudadanoModule = __decorate([
        core_1.NgModule({
            imports: [common_1.CommonModule, ng2_bootstrap_1.Ng2BootstrapModule.forRoot(), angular2_select_1.SelectModule],
            declarations: [ciudadano_component_1.CiudadanoComponent, new_component_1.NewComponent, edit_component_1.EditComponent],
            exports: [ciudadano_component_1.CiudadanoComponent, new_component_1.NewComponent, edit_component_1.EditComponent],
