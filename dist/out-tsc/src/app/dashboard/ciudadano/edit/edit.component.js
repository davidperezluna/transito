...
var EditComponent = /** @class */ (function () {
    ...
    EditComponent.prototype.ngOnInit = function () {
        ...
        var fecha = this.ciudadano.fechaExpedicionDocumento;
        console.log(fecha.);
    ...
    EditComponent.prototype.onEnviar = function () {
        ...
        this.ciudadano.municipioResidencia = this.municipioResidenciaSelected;
        this.ciudadano.municipioNacimiento = this.municipioNacimientoSelected;
        this.ciudadano.tipiIdentificacion = this.tipoIdentificacionSelected;
