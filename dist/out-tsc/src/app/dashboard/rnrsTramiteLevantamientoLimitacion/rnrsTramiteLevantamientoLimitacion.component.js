...
var RnrsTramiteLevantamientoLimitacionComponent = (function () {
    function RnrsTramiteLevantamientoLimitacionComponent(_VehiculoLimitacionService, _VehiculoService, _loginService) {
    ...
    RnrsTramiteLevantamientoLimitacionComponent.prototype.ngOnInit = function () {
        var _this = this;
    ...
    RnrsTramiteLevantamientoLimitacionComponent.prototype.iniciarTabla = function () {
    ...
    RnrsTramiteLevantamientoLimitacionComponent.prototype.ready = function (isCreado) {
        if (isCreado) {
            this.formIndex = true;
            this.ngOnInit();
        }
    };
    RnrsTramiteLevantamientoLimitacionComponent.prototype.onKeyPlaca = function () {
        var _this = this;
    ...
    RnrsTramiteLevantamientoLimitacionComponent.prototype.enviarTramite = function (limitacionVehiculo) {
        var _this = this;
        var token = this._loginService.getToken();
    ...
    RnrsTramiteLevantamientoLimitacionComponent.prototype.onCancelar = function () {
        this.listaLimitacionVehiculo = false;
        this.limitacionVehiculoM = false;
        this.limitacionVehiculoEncontrada = 1;
    };
    RnrsTramiteLevantamientoLimitacionComponent.prototype.ver = function (limitacionVehiculoP) {
        this.limitacionVehiculoM = true;
        this.limitacionVehiculoMostrar = limitacionVehiculoP;
        this.listaLimitacionVehiculo = false;
    };
    return RnrsTramiteLevantamientoLimitacionComponent;
}());
RnrsTramiteLevantamientoLimitacionComponent = __decorate([
    core_1.Component({
        selector: 'app-index',
...
], RnrsTramiteLevantamientoLimitacionComponent);
exports.RnrsTramiteLevantamientoLimitacionComponent = RnrsTramiteLevantamientoLimitacionComponent;
//# sourceMappingURL=rnrsTramiteLevantamientoLimitacion.component.js.map