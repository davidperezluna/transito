...
var modalidad_modelo_1 = require("../modalidad.modelo");
var modalidad_service_1 = require("../../../services/modalidad.service");
var login_service_1 = require("../../../services/login.service");
var sweetalert2_1 = require("sweetalert2");
var NewComponent = (function () {
    function NewComponent(_ModalidadService, _loginService) {
        this._ModalidadService = _ModalidadService;
        this._loginService = _loginService;
        this.ready = new core_1.EventEmitter();
    }
    NewComponent.prototype.ngOnInit = function () {
        this.modalidad = new modalidad_modelo_1.Modalidad(null, null, null);
    };
    ...
    NewComponent.prototype.onEnviar = function () {
        ...
        this._ModalidadService.register(this.modalidad, token).subscribe(function (response) {
            ...
            if (_this.respuesta.status == 'success') {
                ...
                sweetalert2_1.default({
                    title: 'Error!',
                    text: 'El modalidad ' + _this.modalidad.nombre + ' ya se encuentra registrado',
                    type: 'error',
                    confirmButtonText: 'Aceptar'
                });
            }
