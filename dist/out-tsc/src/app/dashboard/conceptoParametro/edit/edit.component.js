...
var EditComponent = (function () {
    function EditComponent(_ConceptoParametroService, _loginService) {
        this._ConceptoParametroService = _ConceptoParametroService;
        this._loginService = _loginService;
        this.ready = new core_1.EventEmitter();
        this.conceptoParametro = null;
    }
    ...
    EditComponent.prototype.onEnviar = function () {
        ...
        this._ConceptoParametroService.editConceptoParametro(this.conceptoParametro, token).subscribe(function (response) {
...
__decorate([
    core_1.Input(),
    __metadata("design:type", Object)
], EditComponent.prototype, "conceptoParametro", void 0);
