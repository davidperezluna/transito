...
var EditComponent = (function () {
    function EditComponent(_generoService, _loginService) {
    ...
    EditComponent.prototype.ngOnInit = function () { console.log(this.genero); };
    EditComponent.prototype.onCancelar = function () { this.ready.emit(true); };
    EditComponent.prototype.onEnviar = function () {
        var _this = this;
        var token = this._loginService.getToken();
        this._generoService.editGenero(this.genero, token).subscribe(function (response) {
...
__decorate([
    core_1.Input(),
    __metadata("design:type", Object)
], EditComponent.prototype, "genero", void 0);
