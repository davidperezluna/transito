...
var genero_modelo_1 = require("../genero.modelo");
var genero_service_1 = require("../../../services/genero.service");
var login_service_1 = require("../../../services/login.service");
var sweetalert2_1 = require("sweetalert2");
var NewComponent = (function () {
    function NewComponent(_GeneroService, _loginService) {
        this._GeneroService = _GeneroService;
        this._loginService = _loginService;
        this.ready = new core_1.EventEmitter();
    }
    NewComponent.prototype.ngOnInit = function () {
        this.genero = new genero_modelo_1.Genero(null, null, null);
    };
    ...
    NewComponent.prototype.onEnviar = function () {
        ...
        this._GeneroService.register(this.genero, token).subscribe(function (response) {
