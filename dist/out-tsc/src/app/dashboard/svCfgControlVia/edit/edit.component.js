...
var EditComponent = (function () {
    ...
    EditComponent.prototype.ngOnInit = function () {
        ...
        this._TipoControlService.getTipoControlSelect().subscribe(function (response) {
            ...
            setTimeout(function () {
                _this.tipoControlSelected = [_this.controlVia.tipoControl.id];
            });
        }, function (error) {
    ...
    EditComponent.prototype.onEnviar = function () {
        ...
        this._ControlViaService.edit(this.controlVia, token).subscribe(function (response) {
...
__decorate([
    core_1.Input(),
    __metadata("design:type", Object)
], EditComponent.prototype, "controlVia", void 0);
