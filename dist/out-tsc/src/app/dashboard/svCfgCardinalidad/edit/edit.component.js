...
var EditComponent = (function () {
    function EditComponent(_CardinalidadService, _loginService) {
    ...
    EditComponent.prototype.onEnviar = function () {
        ...
        this._CardinalidadService.edit(this.cardinalidad, token).subscribe(function (response) {
...
__decorate([
    core_1.Input(),
    __metadata("design:type", Object)
], EditComponent.prototype, "cardinalidad", void 0);
