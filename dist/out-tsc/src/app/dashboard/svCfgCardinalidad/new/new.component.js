...
var svCfgCardinalidad_modelo_1 = require("../svCfgCardinalidad.modelo");
var svCfgCardinalidad_service_1 = require("../../../services/svCfgCardinalidad.service");
var login_service_1 = require("../../../services/login.service");
var sweetalert2_1 = require("sweetalert2");
var NewComponent = (function () {
    function NewComponent(_CardinalidadService, _loginService) {
        this._CardinalidadService = _CardinalidadService;
        this._loginService = _loginService;
        this.ready = new core_1.EventEmitter();
    }
    NewComponent.prototype.ngOnInit = function () {
        this.cardinalidad = new svCfgCardinalidad_modelo_1.SvCfgCardinalidad(null, null);
    };
    ...
    NewComponent.prototype.onEnviar = function () {
        ...
        this._CardinalidadService.register(this.cardinalidad, token).subscribe(function (response) {
