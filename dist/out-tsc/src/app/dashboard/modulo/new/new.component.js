...
var modulo_modelo_1 = require("../modulo.modelo");
var modulo_service_1 = require("../../../services/modulo.service");
var login_service_1 = require("../../../services/login.service");
var sweetalert2_1 = require("sweetalert2");
var NewComponent = (function () {
    function NewComponent(_ModuloService, _loginService) {
        this._ModuloService = _ModuloService;
        this._loginService = _loginService;
        this.ready = new core_1.EventEmitter();
    }
    NewComponent.prototype.ngOnInit = function () {
        this.modulo = new modulo_modelo_1.Modulo(null, null, null, null, null);
    };
    ...
    NewComponent.prototype.onEnviar = function () {
        ...
        this._ModuloService.register(this.modulo, token).subscribe(function (response) {
            ...
            if (_this.respuesta.status == 'success') {
                ...
                sweetalert2_1.default({
                    title: 'Error!',
                    text: 'El modulo ' + _this.modulo.nombre + ' ya se encuentra registrado',
                    type: 'error',
                    confirmButtonText: 'Aceptar'
                });
            }
