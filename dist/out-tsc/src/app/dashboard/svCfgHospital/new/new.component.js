...
var svCfgHospital_modelo_1 = require("../svCfgHospital.modelo");
...
var NewComponent = (function () {
    function NewComponent(_HospitalService, _loginService, _MunicipioService, _SedeOperativaService) {
    ...
    NewComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.hospital = new svCfgHospital_modelo_1.SvCfgHospital(null, null, null, null);
    ...
    NewComponent.prototype.onEnviar = function () {
        ...
        this._HospitalService.register(this.hospital, token).subscribe(function (response) {
