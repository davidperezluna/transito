...
var EditComponent = (function () {
    function EditComponent(_tipoCorrespondenciaService, _loginService) {
    ...
    EditComponent.prototype.ngOnInit = function () { console.log(this.tipoCorrespondencia); };
    EditComponent.prototype.onCancelar = function () { this.ready.emit(true); };
    EditComponent.prototype.onEnviar = function () {
        var _this = this;
        var token = this._loginService.getToken();
        this._tipoCorrespondenciaService.edit(this.tipoCorrespondencia, token).subscribe(function (response) {
...
__decorate([
    core_1.Input(),
    __metadata("design:type", Object)
], EditComponent.prototype, "tipoCorrespondencia", void 0);
