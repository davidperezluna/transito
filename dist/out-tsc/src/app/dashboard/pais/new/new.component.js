...
var pais_modelo_1 = require("../pais.modelo");
var pais_service_1 = require("../../../services/pais.service");
var login_service_1 = require("../../../services/login.service");
var sweetalert2_1 = require("sweetalert2");
var NewComponent = (function () {
    function NewComponent(_PaisService, _loginService) {
        this._PaisService = _PaisService;
        this._loginService = _loginService;
        this.ready = new core_1.EventEmitter();
    }
    NewComponent.prototype.ngOnInit = function () {
        this.pais = new pais_modelo_1.Pais(null, null);
    };
    ...
    NewComponent.prototype.onEnviar = function () {
        ...
        this._PaisService.register(this.pais, token).subscribe(function (response) {
