...
var EditComponent = (function () {
    function EditComponent(_paisService, _loginService) {
    ...
    EditComponent.prototype.ngOnInit = function () { console.log(this.pais); };
    EditComponent.prototype.onCancelar = function () { this.ready.emit(true); };
    EditComponent.prototype.onEnviar = function () {
        var _this = this;
        var token = this._loginService.getToken();
        this._paisService.editPais(this.pais, token).subscribe(function (response) {
...
__decorate([
    core_1.Input(),
    __metadata("design:type", Object)
], EditComponent.prototype, "pais", void 0);
