...
var DepartamentoComponent = (function () {
    function DepartamentoComponent(_DepartamentoService, _loginService) {
    ...
    DepartamentoComponent.prototype.iniciarTabla = function () {
    ...
    DepartamentoComponent.prototype.onNew = function () {
        this.formNew = true;
        this.formIndex = false;
        this.table.destroy();
    };
    DepartamentoComponent.prototype.ready = function (isCreado) {
        if (isCreado) {
            this.formNew = false;
            this.formEdit = false;
            this.formIndex = true;
    ...
    DepartamentoComponent.prototype.deleteDepartamento = function (id) {
        var _this = this;
        sweetalert2_1.default({
            title: '¿Estás seguro?',
            ...
            if (result.value) {
                ...
                _this._DepartamentoService.deleteDepartamento(token, id).subscribe(function (response) {
                    sweetalert2_1.default({
                        title: 'Eliminado!',
    ...
    DepartamentoComponent.prototype.editDepartamento = function (departamento) {
